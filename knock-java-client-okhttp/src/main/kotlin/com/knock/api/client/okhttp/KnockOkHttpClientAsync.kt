...
package com.knock.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.knock.api.client.KnockClientAsync
import com.knock.api.client.KnockClientAsyncImpl
import com.knock.api.core.ClientOptions
import com.knock.api.core.Timeout
...
class KnockOkHttpClientAsync private constructor() {
    ...
    companion object {
         ...
         * [KnockOkHttpClientAsync].
         */
        @JvmStatic
        fun builder() = Builder()

        @JvmStatic
        fun fromEnv(): KnockClientAsync = builder().fromEnv().build()
    }
    ...
    class Builder internal constructor() {
        ...
        fun build(): KnockClientAsync =
            KnockClientAsyncImpl(clientOptions
