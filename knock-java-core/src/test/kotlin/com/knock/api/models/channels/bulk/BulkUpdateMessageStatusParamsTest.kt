...
package com.knock.api.models.channels.bulk
...
class BulkUpdateMessageStatusParamsTest {
    ...
    @Test
    fun body() {
      val params = BulkUpdateMessageStatusParams.builder()
          .channelId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .action(BulkUpdateMessageStatusParams.Action.SEEN)
          .archived(BulkUpdateMessageStatusParams.Archived.EXCLUDE)
          .deliveryStatus(BulkUpdateMessageStatusParams.DeliveryStatus.QUEUED)
      ...
      assertThat(body.deliveryStatus()).contains(BulkUpdateMessageStatusParams.DeliveryStatus.QUEUED)
      assertThat(body.engagementStatus()).contains(BulkUpdateMessageStatusParams.EngagementStatus.SEEN)
      ...
      assertThat(body.recipientIds()).contains(listOf(
        "recipient1", "recipient2"
      ))
      assertThat(body.tenants()).contains(listOf(
        "tenant1", "tenant2"
      ))
      assertThat(body.triggerData()).contains("{\"key\":\"value\"}")
      assertThat(body.workflows()).contains(listOf(
        "workflow1", "workflow2"
      ))
    }
    ...
    fun getPathParam() {
      ...
      // path param "action"
      assertThat(params.getPathParam(1)).isEqualTo(BulkUpdateMessageStatusParams.Action.SEEN.toString())
