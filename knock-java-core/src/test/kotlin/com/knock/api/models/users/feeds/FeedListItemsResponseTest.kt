...
class FeedListItemsResponseTest {
    ...
    fun createFeedListItemsResponse() {
      val feedListItemsResponse = FeedListItemsResponse.builder()
          ...
          .addActor(User.builder()
              ...
              .timezone(null)
              .build())
          .addBlock(FeedListItemsResponse.Block.MessageInAppFeedContentBlock.builder()
              .content("This is a message in an app feed")
              .name("body")
              .rendered("<p>This is a message in an app feed</p>")
              .type(FeedListItemsResponse.Block.MessageInAppFeedContentBlock.Type.MARKDOWN)
              .build())
          .data(FeedListItemsResponse.Data.builder()
              .putAdditionalProperty("foo", JsonValue.from("bar"))
              .build())
          .insertedAt("2021-01-01T00:00:00Z")
          .source(FeedListItemsResponse.Source.builder()
      ...
      assertThat(feedListItemsResponse.activities()).containsExactly(Activity.builder()
          .id("2FVHPWxRqNuXQ9krvNP5A6Z4qXe")
          ._typename("Activity")
          .actor(User.builder()
              .id("id")
          ...
          .updatedAt(OffsetDateTime.parse("2024-01-01T00:00:00Z"))
          .build())
      assertThat(feedListItemsResponse.actors()).containsExactly(Recipient.ofUser(User.builder()
          .id("jane")
          ._typename("User")
          .updatedAt(OffsetDateTime.parse("2024-05-22T12:00:00Z"))
          .avatar(null)
          ...
          .timezone(null)
          .build()))
      assertThat(feedListItemsResponse.blocks()).containsExactly(FeedListItemsResponse.Block.ofMessageInAppFeedContent(FeedListItemsResponse.Block.MessageInAppFeedContentBlock.builder()
          .content("This is a message in an app feed")
          .name("body")
          .rendered("<p>This is a message in an app feed</p>")
          .type(FeedListItemsResponse.Block.MessageInAppFeedContentBlock.Type.MARKDOWN)
          .build()))
      assertThat(feedListItemsResponse.data()).contains(FeedListItemsResponse.Data.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
      assertThat(feedListItemsResponse.insertedAt()).isEqualTo("2021-01-01T00:00:00Z")
      assertThat(feedListItemsResponse.source()).isEqualTo(FeedListItemsResponse.Source.builder()
          ._typename("NotificationSource")
          .addCategory("collaboration")
          .key("my_source")
          .versionId("123e4567-e89b-12d3-a456-426614174000")
