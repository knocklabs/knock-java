...
class ScheduleTest {
    ...
    fun createSchedule() {
      ...
      assertThat(schedule.recipient()).isEqualTo(Recipient.ofUser(User.builder()
          .id("jane")
          ._typename("User")
          .updatedAt(OffsetDateTime.parse("2024-05-22T12:00:00Z"))
          .avatar(null)
          ...
          .timezone(null)
          .build()))
      assertThat(schedule.repeats()).containsExactly(ScheduleRepeatRule.builder()
          ._typename("ScheduleRepeat")
          .frequency(ScheduleRepeatRule.Frequency.DAILY)
          .dayOfMonth(null)
          .days(listOf(
      ...
      assertThat(schedule.actor()).contains(Recipient.ofUser(User.builder()
          .id("id")
          ._typename("User")
          .updatedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .avatar("avatar")
          ...
          .timezone("timezone")
          .build()))
      assertThat(schedule.data()).contains(Schedule.Data.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
