...
class UserFeedListItemsParamsTest {
    ...
    fun create() {
        UserFeedListItemsParams.builder()
            ...
            .pageSize(0L)
            .source("source")
            .status(UserFeedListItemsParams.Status.UNREAD)
            .tenant("tenant")
    ...
    fun queryParams() {
        ...
        expected.put("archived", UserFeedListItemsParams.Archived.EXCLUDE.toString())
        expected.put("before", "before")
        expected.put("has_tenant", "true")
        expected.put("page_size", "0")
        expected.put("source", "source")
        expected.put("status", UserFeedListItemsParams.Status.UNREAD.toString())
