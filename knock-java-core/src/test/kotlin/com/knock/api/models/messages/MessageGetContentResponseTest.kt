...
class MessageGetContentResponseTest {
    ...
    fun createMessageGetContentResponse() {
      val messageGetContentResponse = MessageGetContentResponse.builder()
          ._typename("MessageContent")
          .data(MessageGetContentResponse.Data.MessageSmsContent.builder()
      ...
      assertThat(messageGetContentResponse.data()).isEqualTo(MessageGetContentResponse.Data.ofMessageSmsContent(MessageGetContentResponse.Data.MessageSmsContent.builder()
          ._typename("MessageSmsContent")
          .body("Hello, world!")
          .to("user_123")
          .build()))
      assertThat(messageGetContentResponse.insertedAt()).isEqualTo(OffsetDateTime.parse("2021-01-01T00:00:00Z"))
