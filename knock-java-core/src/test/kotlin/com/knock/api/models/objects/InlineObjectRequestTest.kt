...
class InlineObjectRequestTest {

    @Test
    fun createInlineObjectRequest() {
      val inlineObjectRequest = InlineObjectRequest.builder()
          .id("project_1")
          .collection("projects")
      ...
      assertThat(inlineObjectRequest.channelData()).contains(InlineChannelDataRequest.builder()
          .putAdditionalProperty("97c5837d-c65c-4d54-aa39-080eeb81c69d", JsonValue.from(mapOf("data" to mapOf("tokens" to listOf("push_token_xxx")))))
          .build())
      assertThat(inlineObjectRequest.createdAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(inlineObjectRequest.preferences()).contains(InlinePreferenceSetRequest.builder()
          .putAdditionalProperty("default", JsonValue.from(mapOf(
            "categories" to mapOf("transactional" to mapOf(
              "channel_types" to mapOf(
                "chat" to true,
