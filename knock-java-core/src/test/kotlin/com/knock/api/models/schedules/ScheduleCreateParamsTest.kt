...
class ScheduleCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = ScheduleCreateParams.builder()
          .addRecipient("user_123")
          .addRepeat(ScheduleRepeatRule.builder()
              ._typename("ScheduleRepeat")
              .frequency(ScheduleRepeatRule.Frequency.DAILY)
      ...
      assertNotNull(body)
      assertThat(body.recipients()).isEqualTo(listOf(ScheduleCreateParams.Recipient.ofString("user_123")))
      assertThat(body.repeats()).isEqualTo(listOf(ScheduleRepeatRule.builder()
          ._typename("ScheduleRepeat")
          .frequency(ScheduleRepeatRule.Frequency.DAILY)
          .dayOfMonth(null)
          .days(listOf(
      ...
      assertThat(body.data()).contains(ScheduleCreateParams.Data.builder()
          .putAdditionalProperty("key", JsonValue.from("bar"))
          .build())
