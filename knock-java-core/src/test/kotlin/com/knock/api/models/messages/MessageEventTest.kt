...
class MessageEventTest {
    ...
    fun createMessageEvent() {
      val messageEvent = MessageEvent.builder()
          ...
          .data(MessageEvent.Data.builder()
      ...
      assertThat(messageEvent.insertedAt()).isEqualTo(OffsetDateTime.parse("2021-01-01T00:00:00Z"))
      ...
      assertThat(messageEvent.data()).contains(MessageEvent.Data.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
    }
}
