...
class BulkOperationTest {
    ...
    fun createBulkOperation() {
      val bulkOperation = BulkOperation.builder()
          ...
          .completedAt(null)
          .errorCount(0L)
          .addErrorItem(BulkOperation.ErrorItem.builder()
              .id("id")
      ...
      assertThat(bulkOperation.insertedAt()).isEqualTo(OffsetDateTime.parse("2024-05-22T12:00:00Z"))
      ...
      assertThat(bulkOperation.updatedAt()).isEqualTo(OffsetDateTime.parse("2024-05-22T12:00:00Z"))
      assertThat(bulkOperation.completedAt()).isEmpty
      assertThat(bulkOperation.errorCount()).contains(0L)
      assertThat(bulkOperation.errorItems().get()).containsExactly(BulkOperation.ErrorItem.builder()
          .id("id")
          .collection("collection")
          .build())
