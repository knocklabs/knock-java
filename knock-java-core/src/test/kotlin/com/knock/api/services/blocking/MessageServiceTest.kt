...
class MessageServiceTest {
    ...
    fun archive() {
      ...
      val message = messageService.archive(MessageArchiveParams.builder()
    ...
    fun get() {
      ...
      val message = messageService.get(MessageGetParams.builder()
          .messageId("1jNaXzB2RZX3LY8wVQnfCKyPnv7")
          .build())
    ...
    fun getContent() {
      ...
      val response = messageService.getContent(MessageGetContentParams.builder()
    ...
    fun listActivities() {
      ...
      val page = messageService.listActivities(MessageListActivitiesParams.builder()
          .messageId("message_id")
          .build())
    ...
    fun listDeliveryLogs() {
      ...
      val page = messageService.listDeliveryLogs(MessageListDeliveryLogsParams.builder()
          .messageId("message_id")
          .build())
    ...
    fun listEvents() {
      ...
      val page = messageService.listEvents(MessageListEventsParams.builder()
          .messageId("message_id")
          .build())
    ...
    fun markAsInteracted() {
      ...
      val message = messageService.markAsInteracted(MessageMarkAsInteractedParams.builder()
          .messageId("1jNaXzB2RZX3LY8wVQnfCKyPnv7")
    ...
    fun markAsRead() {
      ...
      val message = messageService.markAsRead(MessageMarkAsReadParams.builder()
          .messageId("1jNaXzB2RZX3LY8wVQnfCKyPnv7")
          .build())
    ...
    fun markAsSeen() {
      ...
      val message = messageService.markAsSeen(MessageMarkAsSeenParams.builder()
          .messageId("1jNaXzB2RZX3LY8wVQnfCKyPnv7")
          .build())
    ...
    fun markAsUnread() {
      ...
      val message = messageService.markAsUnread(MessageMarkAsUnreadParams.builder()
          .messageId("1jNaXzB2RZX3LY8wVQnfCKyPnv7")
          .build())
    ...
    fun markAsUnseen() {
      ...
      val message = messageService.markAsUnseen(MessageMarkAsUnseenParams.builder()
          .messageId("1jNaXzB2RZX3LY8wVQnfCKyPnv7")
          .build())
    ...
    fun unarchive() {
      ...
      val message = messageService.unarchive(MessageUnarchiveParams.builder()
          .messageId("1jNaXzB2RZX3LY8wVQnfCKyPnv7")
          .build())
