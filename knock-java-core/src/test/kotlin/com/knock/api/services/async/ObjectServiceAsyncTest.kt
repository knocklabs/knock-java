...
class ObjectServiceAsyncTest {
    ...
    fun list() {
      ...
      val pageFuture = objectServiceAsync.list(ObjectListParams.builder()
    ...
    fun delete() {
      ...
      val objectFuture = objectServiceAsync.delete(ObjectDeleteParams.builder()
          .collection("collection")
          .objectId("object_id")
          .build())
    ...
    fun addSubscriptions() {
      ...
      val subscriptionsFuture = objectServiceAsync.addSubscriptions(ObjectAddSubscriptionsParams.builder()
          .collection("collection")
          .objectId("object_id")
          .addRecipient("user_1")
          .addRecipient("user_2")
          .properties(ObjectAddSubscriptionsParams.Properties.builder()
    ...
    fun deleteSubscriptions() {
      ...
      val subscriptionsFuture = objectServiceAsync.deleteSubscriptions(ObjectDeleteSubscriptionsParams.builder()
          .collection("collection")
          .objectId("object_id")
    ...
    fun get() {
      ...
      val objectFuture = objectServiceAsync.get(ObjectGetParams.builder()
          .collection("collection")
          .objectId("object_id")
          .build())
    ...
    fun getChannelData() {
      ...
      val channelDataFuture = objectServiceAsync.getChannelData(ObjectGetChannelDataParams.builder()
          .collection("collection")
          .objectId("object_id")
    ...
    fun getPreferences() {
      ...
      val preferenceSetFuture = objectServiceAsync.getPreferences(ObjectGetPreferencesParams.builder()
          .collection("collection")
          .objectId("object_id")
    ...
    fun listMessages() {
      ...
      val pageFuture = objectServiceAsync.listMessages(ObjectListMessagesParams.builder()
          .collection("projects")
    ...
    fun listSchedules() {
      ...
      val pageFuture = objectServiceAsync.listSchedules(ObjectListSchedulesParams.builder()
          .collection("collection")
          .objectId("object_id")
          .build())
    ...
    fun listSubscriptions() {
      ...
      val pageFuture = objectServiceAsync.listSubscriptions(ObjectListSubscriptionsParams.builder()
          .collection("collection")
          .objectId("object_id")
          .build())
    ...
    fun set() {
      ...
      val objectFuture = objectServiceAsync.set(ObjectSetParams.builder()
          .collection("collection")
          .objectId("object_id")
          .channelData(InlineChannelDataRequest.builder()
              .putAdditionalProperty("97c5837d-c65c-4d54-aa39-080eeb81c69d", JsonValue.from(mapOf("data" to mapOf("tokens" to listOf("push_token_xxx")))))
    ...
    fun setChannelData() {
      ...
      val channelDataFuture = objectServiceAsync.setChannelData(ObjectSetChannelDataParams.builder()
          .collection("collection")
          .objectId("object_id")
          .channelId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun setPreferences() {
      ...
      val preferenceSetFuture = objectServiceAsync.setPreferences(ObjectSetPreferencesParams.builder()
          .collection("collection")
          .objectId("object_id")
          .preferenceSetId("default")
    ...
    fun unsetChannelData() {
      ...
      val responseFuture = objectServiceAsync.unsetChannelData(ObjectUnsetChannelDataParams.builder()
          .collection("collection")
          .objectId("object_id")
          .channelId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
