...
class ScheduleServiceTest {
    ...
    fun create() {
      ...
      val schedules = scheduleService.create(ScheduleCreateParams.builder()
    ...
    fun update() {
      ...
      val schedules = scheduleService.update(ScheduleUpdateParams.builder()
    ...
    fun list() {
      ...
      val page = scheduleService.list(ScheduleListParams.builder()
          .workflow("workflow")
          .build())
    ...
    fun delete() {
      ...
      val schedules = scheduleService.delete(ScheduleDeleteParams.builder()
          .addScheduleId("123e4567-e89b-12d3-a456-426614174000")
          .build())
