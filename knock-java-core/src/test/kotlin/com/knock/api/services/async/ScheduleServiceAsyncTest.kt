...
import com.knock.api.models.schedules.ScheduleRepeatRule
...
class ScheduleServiceAsyncTest {
    ...
    fun create() {
      ...
      val schedulesFuture = scheduleServiceAsync.create(ScheduleCreateParams.builder()
          ...
          .data(ScheduleCreateParams.Data.builder()
    ...
    fun update() {
      ...
      val schedulesFuture = scheduleServiceAsync.update(ScheduleUpdateParams.builder()
          .addScheduleId("123e4567-e89b-12d3-a456-426614174000")
          .actor("string")
          .data(ScheduleUpdateParams.Data.builder()
              .putAdditionalProperty("key", JsonValue.from("bar"))
              .build())
          .endingAt(null)
          .addRepeat(ScheduleRepeatRule.builder()
    ...
    fun list() {
      ...
      val pageFuture = scheduleServiceAsync.list(ScheduleListParams.builder()
          .workflow("workflow")
          .build())
    ...
    fun delete() {
      ...
      val schedulesFuture = scheduleServiceAsync.delete(ScheduleDeleteParams.builder()
          .addScheduleId("123e4567-e89b-12d3-a456-426614174000")
          .build())
