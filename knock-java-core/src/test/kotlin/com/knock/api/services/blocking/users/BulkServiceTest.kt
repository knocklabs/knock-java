...
class BulkServiceTest {
    ...
    fun delete() {
      ...
      val bulkOperation = bulkService.delete(BulkDeleteParams.builder()
          .addUserId("user_1")
          .addUserId("user_2")
          .build())
    ...
    fun identify() {
      ...
      val bulkOperation = bulkService.identify(BulkIdentifyParams.builder()
    ...
    fun setPreferences() {
      ...
      val bulkOperation = bulkService.setPreferences(BulkSetPreferencesParams.builder()
