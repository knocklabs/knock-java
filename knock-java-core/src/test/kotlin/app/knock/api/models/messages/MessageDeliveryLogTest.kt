...
class MessageDeliveryLogTest {
    ...
    fun createMessageDeliveryLog() {
      val messageDeliveryLog = MessageDeliveryLog.builder()
          .id("2FVHPWxRqNuXQ9krvNP5A6Z4qXe")
          ._typename("MessageDeliveryLog")
          .environmentId("123e4567-e89b-12d3-a456-426614174000")
          .insertedAt("2021-01-01T00:00:00Z")
          .request(MessageDeliveryLog.Request.builder()
              .body(MessageDeliveryLog.Request.Body.UnionMember1.builder()
                  .putAdditionalProperty("html_content", JsonValue.from("bar"))
                  .build())
              .headers(MessageDeliveryLog.Request.Headers.builder()
              ...
              .query("?foo=bar")
              .build())
          .response(MessageDeliveryLog.Response.builder()
              .body(MessageDeliveryLog.Response.Body.UnionMember1.builder()
                  .putAdditionalProperty("success", JsonValue.from("bar"))
                  .build())
              .headers(MessageDeliveryLog.Response.Headers.builder()
                  .putAdditionalProperty("Content-Type", JsonValue.from("bar"))
                  .build())
              .status(200L)
              .build())
      ...
      assertThat(messageDeliveryLog.environmentId()).isEqualTo("123e4567-e89b-12d3-a456-426614174000")
      assertThat(messageDeliveryLog.insertedAt()).isEqualTo("2021-01-01T00:00:00Z")
      assertThat(messageDeliveryLog.request()).isEqualTo(MessageDeliveryLog.Request.builder()
          .body(MessageDeliveryLog.Request.Body.UnionMember1.builder()
              .putAdditionalProperty("html_content", JsonValue.from("bar"))
              .build())
          .headers(MessageDeliveryLog.Request.Headers.builder()
          ...
          .query("?foo=bar")
          .build())
      assertThat(messageDeliveryLog.response()).isEqualTo(MessageDeliveryLog.Response.builder()
          .body(MessageDeliveryLog.Response.Body.UnionMember1.builder()
              .putAdditionalProperty("success", JsonValue.from("bar"))
              .build())
          .headers(MessageDeliveryLog.Response.Headers.builder()
