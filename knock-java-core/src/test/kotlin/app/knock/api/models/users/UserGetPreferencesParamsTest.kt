...
internal class UserGetPreferencesParamsTest {
    ...
    @Test
    fun create() {
        UserGetPreferencesParams.builder().userId("user_id").id("default").tenant("tenant").build()
    }

    @Test
    fun pathParams() {
        val params = UserGetPreferencesParams.builder().userId("user_id").id("default").build()
