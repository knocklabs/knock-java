...
internal class BulkCreateSchedulesRequestTest {

    @Test
    fun create() {
        val bulkCreateSchedulesRequest =
        ...
        assertThat(bulkCreateSchedulesRequest.schedules())
            .containsExactly(
                BulkCreateSchedulesRequest.Schedule.builder()
                    .workflow("comment-created")
                    .actor(
    ...
    fun roundtrip() {
        ...
        val roundtrippedBulkCreateSchedulesRequest =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(bulkCreateSchedulesRequest),
                jacksonTypeRef<BulkCreateSchedulesRequest>(),
            )

        assertThat(roundtrippedBulkCreateSchedulesRequest).isEqualTo(bulkCreateSchedulesRequest)
    }
}
