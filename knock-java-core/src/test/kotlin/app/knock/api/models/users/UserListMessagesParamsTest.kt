...
class UserListMessagesParamsTest {
    ...
    @Test
    fun queryParams() {
      val params = UserListMessagesParams.builder()
          .userId("user-123")
          .after("after")
          .before("before")
          .channelId("channel_id")
      ...
      expected.put("engagement_status[]", UserListMessagesParams.EngagementStatus.SEEN.toString())
      expected.put("message_ids[]", "string")
      expected.put("page_size", "0")
      expected.put("source", "source")
      expected.put("status[]", UserListMessagesParams.Status.QUEUED.toString())
