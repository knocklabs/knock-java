...
class PreferenceSetTest {
    ...
    fun createPreferenceSet() {
      val preferenceSet = PreferenceSet.builder()
          .id("default")
          ._typename("PreferenceSet")
          .categories(PreferenceSet.Categories.builder()
          ...
          .channelTypes(PreferenceSetChannelTypes.builder()
              ...
              .sms(PreferenceSetChannelTypeSetting.builder()
                  ...
                  .build())
              .build())
          .workflows(PreferenceSet.Workflows.builder()
      ...
      assertThat(preferenceSet.categories()).contains(PreferenceSet.Categories.builder()
          .putAdditionalProperty("marketing", JsonValue.from(false))
          .putAdditionalProperty("transactional", JsonValue.from(mapOf(
            "channel_types" to mapOf(
              "chat" to true,
          ...
          .build())
      assertThat(preferenceSet.channelTypes()).contains(PreferenceSetChannelTypes.builder()
          .chat(PreferenceSetChannelTypes.Chat.ofBool(true))
          .email(PreferenceSetChannelTypes.Email.ofBool(true))
          .http(PreferenceSetChannelTypes.Http.ofBool(true))
          .inAppFeed(PreferenceSetChannelTypes.InAppFeed.ofBool(true))
          ...
          .sms(PreferenceSetChannelTypeSetting.builder()
              ...
              .build())
          .build())
      assertThat(preferenceSet.workflows()).contains(PreferenceSet.Workflows.builder()
          .putAdditionalProperty("foo", JsonValue.from(mapOf(
            "channel_types" to mapOf(
              "chat" to true,
              "email" to false,
