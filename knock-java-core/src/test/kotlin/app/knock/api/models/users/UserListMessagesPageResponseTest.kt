...
internal class UserListMessagesPageResponseTest {
    ...
    fun create() {
            ...
            UserListMessagesPageResponse.builder()
                .addEntry(
                    Message.builder()
                        ...
                        .metadata(
                            JsonValue.from(
                                mapOf("external_id" to "123e4567-e89b-12d3-a456-426614174000")
                            )
                        )
                        .readAt(null)
                        .recipient("user_123")
                ...
                .pageInfo(
                    UserListMessagesPageResponse.PageInfo.builder()
                        ._typename("PageInfo")
                        .pageSize(25L)
                        .after(null)
                        .before(null)
        ...
        assertThat(userListMessagesPageResponse.pageInfo())
            .isEqualTo(
                UserListMessagesPageResponse.PageInfo.builder()
                    ._typename("PageInfo")
                    .pageSize(25L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedUserListMessagesPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(userListMessagesPageResponse),
                jacksonTypeRef<UserListMessagesPageResponse>(),
            )

        assertThat(roundtrippedUserListMessagesPageResponse).isEqualTo(userListMessagesPageResponse)
    }
}
