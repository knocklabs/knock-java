...
class TenantRequestTest {
    ...
    fun createTenantRequest() {
      val tenantRequest = TenantRequest.builder()
          .id("tenant_123")
          ...
          .preferences(InlinePreferenceSetRequest.builder()
              ...
              .build())
          .settings(TenantRequest.Settings.builder()
              .branding(TenantRequest.Settings.Branding.builder()
      ...
      assertThat(tenantRequest.channelData()).contains(InlineChannelDataRequest.builder()
          .putAdditionalProperty("97c5837d-c65c-4d54-aa39-080eeb81c69d", JsonValue.from(mapOf("data" to mapOf("tokens" to listOf("push_token_xxx")))))
          .build())
      assertThat(tenantRequest.preferences()).contains(InlinePreferenceSetRequest.builder()
          .putAdditionalProperty("default", JsonValue.from(mapOf(
            "categories" to mapOf("transactional" to mapOf(
              "channel_types" to mapOf(
                "chat" to true,
          ...
          .build())
      assertThat(tenantRequest.settings()).contains(TenantRequest.Settings.builder()
          .branding(TenantRequest.Settings.Branding.builder()
              .iconUrl("https://example.com/icon.png")
              .logoUrl("https://example.com/logo.png")
              .primaryColor("#000000")
