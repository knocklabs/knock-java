...
class SubscriptionTest {
    ...
    fun createSubscription() {
      val subscription = Subscription.builder()
          ...
          .properties(Subscription.Properties.builder()
              .putAdditionalProperty("foo", JsonValue.from("bar"))
              .build())
          .build()
      assertThat(subscription).isNotNull
      assertThat(subscription._typename()).isEqualTo("Subscription")
      assertThat(subscription.insertedAt()).isEqualTo(OffsetDateTime.parse("2021-01-01T00:00:00Z"))
      assertThat(subscription.object_()).isEqualTo(Object.builder()
          .id("project_1")
          ._typename("Object")
          .collection("projects")
          .updatedAt(OffsetDateTime.parse("2024-05-22T12:00:00Z"))
          .createdAt(null)
          .build())
      assertThat(subscription.recipient()).isEqualTo(Recipient.ofUser(User.builder()
          .id("jane")
          ._typename("User")
          .updatedAt(OffsetDateTime.parse("2024-05-22T12:00:00Z"))
          .avatar(null)
      ...
      assertThat(subscription.properties()).contains(Subscription.Properties.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
    }
}
