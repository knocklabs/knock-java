...
internal class BulkUpdateMessageStatusParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.archived()).contains(BulkUpdateMessageStatusParams.Archived.INCLUDE)
        assertThat(body.deliveryStatus())
            .contains(BulkUpdateMessageStatusParams.DeliveryStatus.DELIVERED)
        ...
        assertThat(body.recipientGids().getOrNull()).containsExactly("string")
