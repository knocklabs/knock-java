...
internal class ObjectListSchedulesPageResponseTest {

    @Test
    fun create() {
        val objectListSchedulesPageResponse =
            ObjectListSchedulesPageResponse.builder()
                .addEntry(
                    Schedule.builder()
        ...
        assertThat(objectListSchedulesPageResponse.entries())
            .containsExactly(
                Schedule.builder()
                    .id("123e4567-e89b-12d3-a456-426614174000")
                    .insertedAt(OffsetDateTime.parse("2021-01-01T00:00:00Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedObjectListSchedulesPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(objectListSchedulesPageResponse),
                jacksonTypeRef<ObjectListSchedulesPageResponse>(),
            )

        assertThat(roundtrippedObjectListSchedulesPageResponse)
            .isEqualTo(objectListSchedulesPageResponse)
    }
}
