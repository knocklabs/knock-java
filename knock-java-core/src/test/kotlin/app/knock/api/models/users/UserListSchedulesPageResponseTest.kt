...
internal class UserListSchedulesPageResponseTest {

    @Test
    fun create() {
        val userListSchedulesPageResponse =
            UserListSchedulesPageResponse.builder()
                .addEntry(
                    Schedule.builder()
        ...
        assertThat(userListSchedulesPageResponse.entries())
            .containsExactly(
                Schedule.builder()
                    .id("123e4567-e89b-12d3-a456-426614174000")
                    .insertedAt(OffsetDateTime.parse("2021-01-01T00:00:00Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedUserListSchedulesPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(userListSchedulesPageResponse),
                jacksonTypeRef<UserListSchedulesPageResponse>(),
            )

        assertThat(roundtrippedUserListSchedulesPageResponse)
            .isEqualTo(userListSchedulesPageResponse)
    }
}
