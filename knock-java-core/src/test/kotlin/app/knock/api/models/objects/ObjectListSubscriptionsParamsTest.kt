...
class ObjectListSubscriptionsParamsTest {
    ...
    @Test
    fun queryParams() {
      val params = ObjectListSubscriptionsParams.builder()
          .collection("collection")
          .objectId("object_id")
          .after("after")
          .before("before")
      ...
      expected.put("objects[]", ObjectListSubscriptionsParams.Object.ofString("user_123").toString())
      expected.put("page_size", "0")
      expected.put("recipients[]", ObjectListSubscriptionsParams.Recipient.ofString("user_123").toString())
