...
class ObjectAddSubscriptionsParamsTest {
    ...
    @Test
    fun body() {
      val params = ObjectAddSubscriptionsParams.builder()
          .collection("collection")
          .objectId("object_id")
          .addRecipient("user_1")
          .addRecipient("user_2")
      ...
      assertNotNull(body)
      assertThat(body.recipients()).isEqualTo(listOf(
        RecipientRequest.ofString("user_1"), RecipientRequest.ofString("user_2")
      ))
      assertThat(body.properties()).contains(ObjectAddSubscriptionsParams.Properties.builder()
          .putAdditionalProperty("key", JsonValue.from("bar"))
          .build())
    }
