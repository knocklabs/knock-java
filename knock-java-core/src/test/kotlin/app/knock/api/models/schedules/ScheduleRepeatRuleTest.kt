...
class ScheduleRepeatRuleTest {
    ...
    fun createScheduleRepeatRule() {
      val scheduleRepeatRule = ScheduleRepeatRule.builder()
      ...
      assertThat(scheduleRepeatRule.days().get()).containsExactly(ScheduleRepeatRule.Day.MON, ScheduleRepeatRule.Day.TUE, ScheduleRepeatRule.Day.WED, ScheduleRepeatRule.Day.THU, ScheduleRepeatRule.Day.FRI, ScheduleRepeatRule.Day.SAT, ScheduleRepeatRule.Day.SUN)
