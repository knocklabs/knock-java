...
class MessageTest {
    ...
    fun createMessage() {
      ...
      assertThat(message.data()).contains(Message.Data.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
      assertThat(message.engagementStatuses().get()).containsExactly(Message.EngagementStatus.SEEN, Message.EngagementStatus.READ)
      ...
      assertThat(message.metadata()).contains(Message.Metadata.builder()
          .putAdditionalProperty("external_id", JsonValue.from("bar"))
          .build())
      ...
      assertThat(message.source()).contains(Message.Source.builder()
          ._typename("NotificationSource")
          .addCategory("collaboration")
          .key("comment-created")
          .versionId("123e4567-e89b-12d3-a456-426614174000")
