    ...
    fun create() {
        val message =
            Message.builder()
                ...
                .linkClickedAt(null)
                .metadata(
                    JsonValue.from(mapOf("external_id" to "123e4567-e89b-12d3-a456-426614174000"))
                )
                .readAt(null)
                .recipient("user_123")
                .scheduledAt(null)
        ...
        assertThat(message._data()).isEqualTo(JsonValue.from(mapOf("foo" to "bar")))
