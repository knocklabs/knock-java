...
class ObjectServiceTest {
    ...
    fun list() {
      ...
      val page = objectService.list(ObjectListParams.builder()
    ...
    fun delete() {
      ...
      objectService.delete(ObjectDeleteParams.builder()
          .collection("collection")
          .objectId("object_id")
          .build())
    }
    ...
    fun addSubscriptions() {
      ...
      val subscriptions = objectService.addSubscriptions(ObjectAddSubscriptionsParams.builder()
          .collection("collection")
          .objectId("object_id")
          .addRecipient("user_1")
          .addRecipient("user_2")
    ...
    fun deleteSubscriptions() {
      ...
      val subscriptions = objectService.deleteSubscriptions(ObjectDeleteSubscriptionsParams.builder()
          .collection("collection")
          .objectId("object_id")
    ...
    fun get() {
      ...
      val object_ = objectService.get(ObjectGetParams.builder()
          .collection("collection")
          .objectId("object_id")
          .build())
    ...
    fun getChannelData() {
      ...
      val channelData = objectService.getChannelData(ObjectGetChannelDataParams.builder()
          .collection("collection")
          .objectId("object_id")
    ...
    fun getPreferences() {
      ...
      val preferenceSet = objectService.getPreferences(ObjectGetPreferencesParams.builder()
          .collection("collection")
          .objectId("object_id")
    ...
    fun listMessages() {
      ...
      val page = objectService.listMessages(ObjectListMessagesParams.builder()
          .collection("projects")
    ...
    fun listSchedules() {
      ...
      val page = objectService.listSchedules(ObjectListSchedulesParams.builder()
          .collection("collection")
          .objectId("object_id")
          .build())
    ...
    fun listSubscriptions() {
      ...
      val page = objectService.listSubscriptions(ObjectListSubscriptionsParams.builder()
          .collection("collection")
          .objectId("object_id")
          .build())
    ...
    fun set() {
      ...
      val object_ = objectService.set(ObjectSetParams.builder()
          .collection("collection")
          .objectId("object_id")
          .channelData(InlineChannelDataRequest.builder()
              .putAdditionalProperty("97c5837d-c65c-4d54-aa39-080eeb81c69d", JsonValue.from(mapOf("data" to mapOf("tokens" to listOf("push_token_xxx")))))
    ...
    fun setChannelData() {
      ...
      val channelData = objectService.setChannelData(ObjectSetChannelDataParams.builder()
          .collection("collection")
          .objectId("object_id")
          .channelId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun setPreferences() {
      ...
      val preferenceSet = objectService.setPreferences(ObjectSetPreferencesParams.builder()
          .collection("collection")
          .objectId("object_id")
          .preferenceSetId("default")
    ...
    fun unsetChannelData() {
      ...
      objectService.unsetChannelData(ObjectUnsetChannelDataParams.builder()
          .collection("collection")
          .objectId("object_id")
          .channelId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
