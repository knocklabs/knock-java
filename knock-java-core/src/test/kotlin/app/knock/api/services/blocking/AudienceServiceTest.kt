...
class AudienceServiceTest {
    ...
    fun addMembers() {
      ...
      audienceService.addMembers(AudienceAddMembersParams.builder()
          .key("key")
    ...
    fun listMembers() {
      ...
      val response = audienceService.listMembers(AudienceListMembersParams.builder()
          .key("key")
          .build())
    ...
    fun removeMembers() {
      ...
      audienceService.removeMembers(AudienceRemoveMembersParams.builder()
          .key("key")
