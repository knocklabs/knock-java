...
internal class AudienceServiceTest {
    ...
    fun addMembers() {
        ...
        audienceService.addMembers(AudienceAddMembersParams.builder().key("key").build())
    }
    ...
    fun removeMembers() {
        ...
        audienceService.removeMembers(AudienceRemoveMembersParams.builder().key("key").build())
    }
}
