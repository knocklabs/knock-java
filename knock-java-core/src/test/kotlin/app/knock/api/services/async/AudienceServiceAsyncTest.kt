...
class AudienceServiceAsyncTest {
    ...
    fun addMembers() {
      ...
      val responseFuture = audienceServiceAsync.addMembers(AudienceAddMembersParams.builder()
          .key("key")
    ...
    fun listMembers() {
      ...
      val responseFuture = audienceServiceAsync.listMembers(AudienceListMembersParams.builder()
          .key("key")
          .build())
    ...
    fun removeMembers() {
      ...
      val responseFuture = audienceServiceAsync.removeMembers(AudienceRemoveMembersParams.builder()
          .key("key")
