...
class BulkServiceAsyncTest {
    ...
    fun identify() {
      ...
      val bulkOperationFuture = bulkServiceAsync.identify(BulkIdentifyParams.builder()
    ...
    fun setPreferences() {
      ...
      val bulkOperationFuture = bulkServiceAsync.setPreferences(BulkSetPreferencesParams.builder()
