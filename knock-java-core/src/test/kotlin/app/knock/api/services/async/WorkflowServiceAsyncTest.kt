...
class WorkflowServiceAsyncTest {
    ...
    fun cancel() {
      ...
      val responseFuture = workflowServiceAsync.cancel(WorkflowCancelParams.builder()
          .key("key")
    ...
    fun trigger() {
      ...
      val responseFuture = workflowServiceAsync.trigger(WorkflowTriggerParams.builder()
          .key("key")
          .actor("string")
