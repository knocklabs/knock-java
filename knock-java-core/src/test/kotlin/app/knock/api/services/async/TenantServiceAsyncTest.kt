...
class TenantServiceAsyncTest {
    ...
    fun delete() {
      ...
      val tenantFuture = tenantServiceAsync.delete(TenantDeleteParams.builder()
          .tenantId("tenant_id")
          .build())
    ...
    fun get() {
      ...
      val tenantFuture = tenantServiceAsync.get(TenantGetParams.builder()
          .tenantId("tenant_id")
          .build())
    ...
    fun set() {
      ...
      val tenantFuture = tenantServiceAsync.set(TenantSetParams.builder()
          .tenantId("tenant_id")
