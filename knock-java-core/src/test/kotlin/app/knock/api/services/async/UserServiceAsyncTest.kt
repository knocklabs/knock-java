...
class UserServiceAsyncTest {
    ...
    fun update() {
      ...
      val userFuture = userServiceAsync.update(UserUpdateParams.builder()
          .userId("user_id")
    ...
    fun delete() {
      ...
      val userFuture = userServiceAsync.delete(UserDeleteParams.builder()
          .userId("user_id")
          .build())
    ...
    fun get() {
      ...
      val userFuture = userServiceAsync.get(UserGetParams.builder()
          .userId("user_id")
          .build())
    ...
    fun getChannelData() {
      ...
      val channelDataFuture = userServiceAsync.getChannelData(UserGetChannelDataParams.builder()
          .userId("user_id")
    ...
    fun getPreferences() {
      ...
      val preferenceSetFuture = userServiceAsync.getPreferences(UserGetPreferencesParams.builder()
          .userId("user_id")
    ...
    fun listMessages() {
      ...
      val pageFuture = userServiceAsync.listMessages(UserListMessagesParams.builder()
          .userId("user-123")
          .build())
    ...
    fun listPreferences() {
      ...
      val preferenceSetsFuture = userServiceAsync.listPreferences(UserListPreferencesParams.builder()
          .userId("user_id")
          .build())
    ...
    fun listSchedules() {
      ...
      val pageFuture = userServiceAsync.listSchedules(UserListSchedulesParams.builder()
          .userId("user_id")
          .build())
    ...
    fun listSubscriptions() {
      ...
      val pageFuture = userServiceAsync.listSubscriptions(UserListSubscriptionsParams.builder()
          .userId("user_id")
          .build())
    ...
    fun merge() {
      ...
      val userFuture = userServiceAsync.merge(UserMergeParams.builder()
          .userId("user_id")
          .fromUserId("user_1")
          .build())
    ...
    fun setChannelData() {
      ...
      val channelDataFuture = userServiceAsync.setChannelData(UserSetChannelDataParams.builder()
          .userId("user_id")
          .channelId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun setPreferences() {
      ...
      val preferenceSetFuture = userServiceAsync.setPreferences(UserSetPreferencesParams.builder()
          .userId("user_id")
          .preferenceSetId("default")
    ...
    fun unsetChannelData() {
      ...
      val responseFuture = userServiceAsync.unsetChannelData(UserUnsetChannelDataParams.builder()
          .userId("user_id")
          .channelId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
