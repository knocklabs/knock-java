...
class MsTeamServiceTest {
    ...
    fun checkAuth() {
      ...
      val response = msTeamService.checkAuth(MsTeamCheckAuthParams.builder()
    ...
    fun listChannels() {
      ...
      val response = msTeamService.listChannels(MsTeamListChannelsParams.builder()
          .channelId("channel_id")
          .msTeamsTenantObject("ms_teams_tenant_object")
          .teamId("team_id")
    ...
    fun listTeams() {
      ...
      val response = msTeamService.listTeams(MsTeamListTeamsParams.builder()
          .channelId("channel_id")
          .msTeamsTenantObject("ms_teams_tenant_object")
    ...
    fun revokeAccess() {
      ...
      msTeamService.revokeAccess(MsTeamRevokeAccessParams.builder()
          .channelId("channel_id")
          .msTeamsTenantObject("ms_teams_tenant_object")
          .build())
    }
