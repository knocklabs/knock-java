...
class BulkServiceAsyncImpl internal constructor(
    ...
    override fun updateMessageStatus(params: BulkUpdateMessageStatusParams, requestOptions: RequestOptions): CompletableFuture<BulkOperation> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun updateMessageStatus(params: BulkUpdateMessageStatusParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BulkOperation>> {
