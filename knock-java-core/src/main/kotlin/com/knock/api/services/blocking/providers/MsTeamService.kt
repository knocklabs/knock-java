...
interface MsTeamService {
    ...
    /** @see [checkAuth] */
    fun checkAuth(params: MsTeamCheckAuthParams, requestOptions: RequestOptions = RequestOptions.none()): MsTeamCheckAuthResponse
    ...
    /** @see [listChannels] */
    fun listChannels(params: MsTeamListChannelsParams, requestOptions: RequestOptions = RequestOptions.none()): MsTeamListChannelsResponse
    ...
    /** @see [listTeams] */
    fun listTeams(params: MsTeamListTeamsParams, requestOptions: RequestOptions = RequestOptions.none()): MsTeamListTeamsResponse
    ...
    /** @see [revokeAccess] */
    fun revokeAccess(params: MsTeamRevokeAccessParams, requestOptions: RequestOptions = RequestOptions.none()): String

    /**
     * A view of [MsTeamService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
        ...
        /** @see [checkAuth] */
        @MustBeClosed
        fun checkAuth(params: MsTeamCheckAuthParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<MsTeamCheckAuthResponse>
         ...
         */
        @MustBeClosed
        fun listChannels(params: MsTeamListChannelsParams): HttpResponseFor<MsTeamListChannelsResponse> =
            listChannels(
              params, RequestOptions.none()
            )
        ...
        /** @see [listChannels] */
        @MustBeClosed
        fun listChannels(params: MsTeamListChannelsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<MsTeamListChannelsResponse>

        /**
         * Returns a raw HTTP response for `get /v1/providers/ms-teams/{channel_id}/teams`,
         * but is otherwise the same as [MsTeamService.listTeams].
         */
        @MustBeClosed
        ...
        /** @see [listTeams] */
        @MustBeClosed
        fun listTeams(params: MsTeamListTeamsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<MsTeamListTeamsResponse>

        /**
         * Returns a raw HTTP response for
         * `put /v1/providers/ms-teams/{channel_id}/revoke_access`, but is otherwise the
         * same as [MsTeamService.revokeAccess].
         */
        @MustBeClosed
        ...
        /** @see [revokeAccess] */
        @MustBeClosed
        fun revokeAccess(params: MsTeamRevokeAccessParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<String>
    }
}
