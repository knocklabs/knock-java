...
class MsTeamServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : MsTeamService {

    private val withRawResponse: MsTeamService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): MsTeamService.WithRawResponse = withRawResponse

    override fun checkAuth(params: MsTeamCheckAuthParams, requestOptions: RequestOptions): MsTeamCheckAuthResponse =
        // get /v1/providers/ms-teams/{channel_id}/auth_check
        withRawResponse().checkAuth(params, requestOptions).parse()

    override fun listChannels(params: MsTeamListChannelsParams, requestOptions: RequestOptions): MsTeamListChannelsResponse =
        // get /v1/providers/ms-teams/{channel_id}/channels
        withRawResponse().listChannels(params, requestOptions).parse()

    override fun listTeams(params: MsTeamListTeamsParams, requestOptions: RequestOptions): MsTeamListTeamsResponse =
        // get /v1/providers/ms-teams/{channel_id}/teams
        withRawResponse().listTeams(params, requestOptions).parse()

    override fun revokeAccess(params: MsTeamRevokeAccessParams, requestOptions: RequestOptions): String =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun checkAuth(params: MsTeamCheckAuthParams, requestOptions: RequestOptions): HttpResponseFor<MsTeamCheckAuthResponse> {
        ...
        override fun listChannels(params: MsTeamListChannelsParams, requestOptions: RequestOptions): HttpResponseFor<MsTeamListChannelsResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun listTeams(params: MsTeamListTeamsParams, requestOptions: RequestOptions): HttpResponseFor<MsTeamListTeamsResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun revokeAccess(params: MsTeamRevokeAccessParams, requestOptions: RequestOptions): HttpResponseFor<String> {
          val request = HttpRequest.builder()
