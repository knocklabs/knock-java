...
class SlackServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : SlackServiceAsync {

    private val withRawResponse: SlackServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): SlackServiceAsync.WithRawResponse = withRawResponse

    override fun checkAuth(params: SlackCheckAuthParams, requestOptions: RequestOptions): CompletableFuture<SlackCheckAuthResponse> =
        // get /v1/providers/slack/{channel_id}/auth_check
        withRawResponse().checkAuth(params, requestOptions).thenApply { it.parse() }

    override fun listChannels(params: SlackListChannelsParams, requestOptions: RequestOptions): CompletableFuture<SlackListChannelsPageAsync> =
        // get /v1/providers/slack/{channel_id}/channels
        withRawResponse().listChannels(params, requestOptions).thenApply { it.parse() }

    override fun revokeAccess(params: SlackRevokeAccessParams, requestOptions: RequestOptions): CompletableFuture<String> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun checkAuth(params: SlackCheckAuthParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<SlackCheckAuthResponse>> {
        ...
        private val listChannelsHandler: Handler<SlackListChannelsPageAsync.Response> = jsonHandler<SlackListChannelsPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun listChannels(params: SlackListChannelsParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<SlackListChannelsPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              .let {
                  SlackListChannelsPageAsync.of(SlackServiceAsyncImpl(clientOptions), params, it)
              }
          } }
        }
        ...
        override fun revokeAccess(params: SlackRevokeAccessParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
