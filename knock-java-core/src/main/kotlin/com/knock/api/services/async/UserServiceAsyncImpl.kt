...
class UserServiceAsyncImpl internal constructor(
    ...
    override fun update(params: UserUpdateParams, requestOptions: RequestOptions): CompletableFuture<User> =
        // put /v1/users/{user_id}
        withRawResponse().update(params, requestOptions).thenApply { it.parse() }

    override fun list(params: UserListParams, requestOptions: RequestOptions): CompletableFuture<UserListPageAsync> =
        // get /v1/users
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun delete(params: UserDeleteParams, requestOptions: RequestOptions): CompletableFuture<String> =
        // delete /v1/users/{user_id}
        withRawResponse().delete(params, requestOptions).thenApply { it.parse() }

    override fun get(params: UserGetParams, requestOptions: RequestOptions): CompletableFuture<User> =
        // get /v1/users/{user_id}
        withRawResponse().get(params, requestOptions).thenApply { it.parse() }

    override fun getChannelData(params: UserGetChannelDataParams, requestOptions: RequestOptions): CompletableFuture<ChannelData> =
        // get /v1/users/{user_id}/channel_data/{channel_id}
        withRawResponse().getChannelData(params, requestOptions).thenApply { it.parse() }

    override fun getPreferences(params: UserGetPreferencesParams, requestOptions: RequestOptions): CompletableFuture<PreferenceSet> =
    ...
    override fun listMessages(params: UserListMessagesParams, requestOptions: RequestOptions): CompletableFuture<UserListMessagesPageAsync> =
        // get /v1/users/{user_id}/messages
        withRawResponse().listMessages(params, requestOptions).thenApply { it.parse() }

    override fun listPreferences(params: UserListPreferencesParams, requestOptions: RequestOptions): CompletableFuture<List<PreferenceSet>> =
        // get /v1/users/{user_id}/preferences
        withRawResponse().listPreferences(params, requestOptions).thenApply { it.parse() }

    override fun listSchedules(params: UserListSchedulesParams, requestOptions: RequestOptions): CompletableFuture<UserListSchedulesPageAsync> =
        // get /v1/users/{user_id}/schedules
        withRawResponse().listSchedules(params, requestOptions).thenApply { it.parse() }

    override fun listSubscriptions(params: UserListSubscriptionsParams, requestOptions: RequestOptions): CompletableFuture<UserListSubscriptionsPageAsync> =
        // get /v1/users/{user_id}/subscriptions
        withRawResponse().listSubscriptions(params, requestOptions).thenApply { it.parse() }

    override fun merge(params: UserMergeParams, requestOptions: RequestOptions): CompletableFuture<User> =
        // post /v1/users/{user_id}/merge
        withRawResponse().merge(params, requestOptions).thenApply { it.parse() }

    override fun setChannelData(params: UserSetChannelDataParams, requestOptions: RequestOptions): CompletableFuture<ChannelData> =
        // put /v1/users/{user_id}/channel_data/{channel_id}
        withRawResponse().setChannelData(params, requestOptions).thenApply { it.parse() }

    override fun setPreferences(params: UserSetPreferencesParams, requestOptions: RequestOptions): CompletableFuture<PreferenceSet> =
    ...
    override fun unsetChannelData(params: UserUnsetChannelDataParams, requestOptions: RequestOptions): CompletableFuture<String> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val feeds: FeedServiceAsync.WithRawResponse by lazy { FeedServiceAsyncImpl.WithRawResponseImpl(clientOptions) }
        ...
        override fun update(params: UserUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<User>> {
        ...
        private val listHandler: Handler<UserListPageAsync.Response> = jsonHandler<UserListPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun list(params: UserListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<UserListPageAsync>> {
          val request = HttpRequest.builder()
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              .let {
                  UserListPageAsync.of(UserServiceAsyncImpl(clientOptions), params, it)
              }
          } }
        }
        ...
        override fun delete(params: UserDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
        ...
        override fun get(params: UserGetParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<User>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("v1", "users", params.getPathParam(0))
            .build()
        ...
        override fun getChannelData(params: UserGetChannelDataParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ChannelData>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun getPreferences(params: UserGetPreferencesParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PreferenceSet>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        private val listMessagesHandler: Handler<UserListMessagesPageAsync.Response> = jsonHandler<UserListMessagesPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun listMessages(params: UserListMessagesParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<UserListMessagesPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              .let {
                  UserListMessagesPageAsync.of(UserServiceAsyncImpl(clientOptions), params, it)
              }
          } }
        }
        ...
        override fun listPreferences(params: UserListPreferencesParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<PreferenceSet>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        private val listSchedulesHandler: Handler<UserListSchedulesPageAsync.Response> = jsonHandler<UserListSchedulesPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun listSchedules(params: UserListSchedulesParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<UserListSchedulesPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              .let {
                  UserListSchedulesPageAsync.of(UserServiceAsyncImpl(clientOptions), params, it)
              }
          } }
        }

        private val listSubscriptionsHandler: Handler<UserListSubscriptionsPageAsync.Response> = jsonHandler<UserListSubscriptionsPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun listSubscriptions(params: UserListSubscriptionsParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<UserListSubscriptionsPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              .let {
                  UserListSubscriptionsPageAsync.of(UserServiceAsyncImpl(clientOptions), params, it)
              }
          } }
        }
        ...
        override fun merge(params: UserMergeParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<User>> {
          val request = HttpRequest.builder()
        ...
        override fun setChannelData(params: UserSetChannelDataParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ChannelData>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.PUT)
            .addPathSegments("v1", "users", params.getPathParam(0), "channel_data", params.getPathParam(1))
            .body(json(clientOptions.jsonMapper, params._body()))
        ...
        override fun setPreferences(params: UserSetPreferencesParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PreferenceSet>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.PUT)
            .addPathSegments("v1", "users", params.getPathParam(0), "preferences", params.getPathParam(1))
            .body(json(clientOptions.jsonMapper, params._body()))
        ...
        override fun unsetChannelData(params: UserUnsetChannelDataParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<String>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.DELETE)
            .addPathSegments("v1", "users", params.getPathParam(0), "channel_data", params.getPathParam(1))
            .apply { params._body().ifPresent{ body(json(clientOptions.jsonMapper, it)) } }
