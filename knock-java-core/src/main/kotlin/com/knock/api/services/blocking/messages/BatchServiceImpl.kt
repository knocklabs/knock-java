...
class BatchServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : BatchService {

    private val withRawResponse: BatchService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): BatchService.WithRawResponse = withRawResponse

    override fun archive(params: BatchArchiveParams, requestOptions: RequestOptions): List<Message> =
        // post /v1/messages/batch/archived
        withRawResponse().archive(params, requestOptions).parse()

    override fun getContent(params: BatchGetContentParams, requestOptions: RequestOptions): List<MessageContent> =
        // get /v1/messages/batch/content
        withRawResponse().getContent(params, requestOptions).parse()

    override fun markAsInteracted(params: BatchMarkAsInteractedParams, requestOptions: RequestOptions): List<Message> =
        // post /v1/messages/batch/interacted
        withRawResponse().markAsInteracted(params, requestOptions).parse()

    override fun markAsRead(params: BatchMarkAsReadParams, requestOptions: RequestOptions): List<Message> =
        // post /v1/messages/batch/read
        withRawResponse().markAsRead(params, requestOptions).parse()

    override fun markAsSeen(params: BatchMarkAsSeenParams, requestOptions: RequestOptions): List<Message> =
        // post /v1/messages/batch/seen
        withRawResponse().markAsSeen(params, requestOptions).parse()

    override fun markAsUnread(params: BatchMarkAsUnreadParams, requestOptions: RequestOptions): List<Message> =
        // post /v1/messages/batch/unread
        withRawResponse().markAsUnread(params, requestOptions).parse()

    override fun markAsUnseen(params: BatchMarkAsUnseenParams, requestOptions: RequestOptions): List<Message> =
        // post /v1/messages/batch/unseen
        withRawResponse().markAsUnseen(params, requestOptions).parse()

    override fun unarchive(params: BatchUnarchiveParams, requestOptions: RequestOptions): List<Message> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun archive(params: BatchArchiveParams, requestOptions: RequestOptions): HttpResponseFor<List<Message>> {
        ...
        override fun getContent(params: BatchGetContentParams, requestOptions: RequestOptions): HttpResponseFor<List<MessageContent>> {
          val request = HttpRequest.builder()
        ...
        override fun markAsInteracted(params: BatchMarkAsInteractedParams, requestOptions: RequestOptions): HttpResponseFor<List<Message>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun markAsRead(params: BatchMarkAsReadParams, requestOptions: RequestOptions): HttpResponseFor<List<Message>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun markAsSeen(params: BatchMarkAsSeenParams, requestOptions: RequestOptions): HttpResponseFor<List<Message>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun markAsUnread(params: BatchMarkAsUnreadParams, requestOptions: RequestOptions): HttpResponseFor<List<Message>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun markAsUnseen(params: BatchMarkAsUnseenParams, requestOptions: RequestOptions): HttpResponseFor<List<Message>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun unarchive(params: BatchUnarchiveParams, requestOptions: RequestOptions): HttpResponseFor<List<Message>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
