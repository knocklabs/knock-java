...
interface WorkflowService {
     ...
     */
    fun cancel(params: WorkflowCancelParams): String =
        cancel(
          params, RequestOptions.none()
        )

    /** @see [cancel] */
    fun cancel(params: WorkflowCancelParams, requestOptions: RequestOptions = RequestOptions.none()): String
    ...
    /** @see [trigger] */
    fun trigger(params: WorkflowTriggerParams, requestOptions: RequestOptions = RequestOptions.none()): WorkflowTriggerResponse

    /**
     * A view of [WorkflowService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * otherwise the same as [WorkflowService.cancel].
         */
        @MustBeClosed
        ...
        /** @see [cancel] */
        @MustBeClosed
        fun cancel(params: WorkflowCancelParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<String>

        /**
         * Returns a raw HTTP response for `post /v1/workflows/{key}/trigger`, but is
         * otherwise the same as [WorkflowService.trigger].
         */
        @MustBeClosed
        ...
        /** @see [trigger] */
        @MustBeClosed
        fun trigger(params: WorkflowTriggerParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<WorkflowTriggerResponse>
    }
}
