...
@NoAutoDetect
class MessageGetContentResponse @JsonCreator private constructor(
    ...
    @JsonProperty("message_id") @ExcludeMissing private val messageId: JsonField<String> = JsonMissing.of(),
    ...
    fun validate(): MessageGetContentResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageGetContentResponse: MessageGetContentResponse) =
            apply {
        ...
        /** The contents of an email message */
        fun data(messageEmailContent: Data.MessageEmailContent) = data(Data.ofMessageEmailContent(messageEmailContent))

        /** The contents of an SMS message */
        fun data(messageSmsContent: Data.MessageSmsContent) = data(Data.ofMessageSmsContent(messageSmsContent))

        /** The contents of a push message */
        fun data(messagePushContent: Data.MessagePushContent) = data(Data.ofMessagePushContent(messagePushContent))

        /** The contents of a chat message */
        fun data(messageChatContent: Data.MessageChatContent) = data(Data.ofMessageChatContent(messageChatContent))

        /** The contents of a message in an app feed */
        fun data(messageInAppFeedContent: Data.MessageInAppFeedContent) = data(Data.ofMessageInAppFeedContent(messageInAppFeedContent))
        ...
        fun messageId(messageId: JsonField<String>) =
            apply {
    ...
    class Data private constructor(
        ...
        /** The contents of an email message */
        fun messageEmailContent(): Optional<MessageEmailContent> = Optional.ofNullable(messageEmailContent)

        /** The contents of an SMS message */
        fun messageSmsContent(): Optional<MessageSmsContent> = Optional.ofNullable(messageSmsContent)

        /** The contents of a push message */
        fun messagePushContent(): Optional<MessagePushContent> = Optional.ofNullable(messagePushContent)

        /** The contents of a chat message */
        fun messageChatContent(): Optional<MessageChatContent> = Optional.ofNullable(messageChatContent)

        /** The contents of a message in an app feed */
        fun messageInAppFeedContent(): Optional<MessageInAppFeedContent> = Optional.ofNullable(messageInAppFeedContent)
        ...
        /** The contents of an email message */
        fun asMessageEmailContent(): MessageEmailContent = messageEmailContent.getOrThrow("messageEmailContent")

        /** The contents of an SMS message */
        fun asMessageSmsContent(): MessageSmsContent = messageSmsContent.getOrThrow("messageSmsContent")

        /** The contents of a push message */
        fun asMessagePushContent(): MessagePushContent = messagePushContent.getOrThrow("messagePushContent")

        /** The contents of a chat message */
        fun asMessageChatContent(): MessageChatContent = messageChatContent.getOrThrow("messageChatContent")

        /** The contents of a message in an app feed */
        fun asMessageInAppFeedContent(): MessageInAppFeedContent = messageInAppFeedContent.getOrThrow("messageInAppFeedContent")
        ...
        fun <T> accept(visitor: Visitor<T>): T {
          return when {
              ...
              messageInAppFeedContent != null -> visitor.visitMessageInAppFeedContent(messageInAppFeedContent)
        ...
        fun validate(): Data =
            apply {
                ...
                accept(object : Visitor<Unit> {
                    override fun visitMessageEmailContent(messageEmailContent: MessageEmailContent) {
                    ...
                    override fun visitMessageInAppFeedContent(messageInAppFeedContent: MessageInAppFeedContent) {
        ...
        override fun toString(): String =
            when {
                ...
                messageInAppFeedContent != null -> "Data{messageInAppFeedContent=$messageInAppFeedContent}"
        ...
        companion object {
            ...
            /** The contents of an email message */
            @JvmStatic
            fun ofMessageEmailContent(messageEmailContent: MessageEmailContent) = Data(messageEmailContent = messageEmailContent)

            /** The contents of an SMS message */
            @JvmStatic
            fun ofMessageSmsContent(messageSmsContent: MessageSmsContent) = Data(messageSmsContent = messageSmsContent)

            /** The contents of a push message */
            @JvmStatic
            fun ofMessagePushContent(messagePushContent: MessagePushContent) = Data(messagePushContent = messagePushContent)

            /** The contents of a chat message */
            @JvmStatic
            fun ofMessageChatContent(messageChatContent: MessageChatContent) = Data(messageChatContent = messageChatContent)

            /** The contents of a message in an app feed */
            @JvmStatic
            fun ofMessageInAppFeedContent(messageInAppFeedContent: MessageInAppFeedContent) = Data(messageInAppFeedContent = messageInAppFeedContent)
        }
        ...
        internal class Deserializer : BaseDeserializer<Data>(Data::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Data {
              ...
              tryDeserialize(node, jacksonTypeRef<MessageEmailContent>()){ it.validate() }?.let {
                  return Data(messageEmailContent = it, _json = json)
              }
              tryDeserialize(node, jacksonTypeRef<MessageSmsContent>()){ it.validate() }?.let {
                  return Data(messageSmsContent = it, _json = json)
              }
              tryDeserialize(node, jacksonTypeRef<MessagePushContent>()){ it.validate() }?.let {
                  return Data(messagePushContent = it, _json = json)
              }
              tryDeserialize(node, jacksonTypeRef<MessageChatContent>()){ it.validate() }?.let {
                  return Data(messageChatContent = it, _json = json)
              }
              tryDeserialize(node, jacksonTypeRef<MessageInAppFeedContent>()){ it.validate() }?.let {
        ...
        internal class Serializer : BaseSerializer<Data>(Data::class) {
            ...
            override fun serialize(value: Data, generator: JsonGenerator, provider: SerializerProvider) {
              when {
                  value.messageEmailContent != null -> generator.writeObject(value.messageEmailContent)
                  value.messageSmsContent != null -> generator.writeObject(value.messageSmsContent)
                  value.messagePushContent != null -> generator.writeObject(value.messagePushContent)
                  value.messageChatContent != null -> generator.writeObject(value.messageChatContent)
                  value.messageInAppFeedContent != null -> generator.writeObject(value.messageInAppFeedContent)
        ...
        /** The contents of an email message */
        @NoAutoDetect
        class MessageEmailContent @JsonCreator private constructor(
            @JsonProperty("__typename") @ExcludeMissing private val _typename: JsonField<String> = JsonMissing.of(),
            @JsonProperty("from") @ExcludeMissing private val from: JsonField<String> = JsonMissing.of(),
            @JsonProperty("html_body") @ExcludeMissing private val htmlBody: JsonField<String> = JsonMissing.of(),
            @JsonProperty("subject_line") @ExcludeMissing private val subjectLine: JsonField<String> = JsonMissing.of(),
            @JsonProperty("text_body") @ExcludeMissing private val textBody: JsonField<String> = JsonMissing.of(),
            @JsonProperty("to") @ExcludeMissing private val to: JsonField<String> = JsonMissing.of(),
            @JsonProperty("bcc") @ExcludeMissing private val bcc: JsonField<String> = JsonMissing.of(),
            @JsonProperty("cc") @ExcludeMissing private val cc: JsonField<String> = JsonMissing.of(),
            @JsonProperty("reply_to") @ExcludeMissing private val replyTo: JsonField<String> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
            ...
            @JsonProperty("from")
            @ExcludeMissing
            fun _from(): JsonField<String> = from

            @JsonProperty("html_body")
            @ExcludeMissing
            fun _htmlBody(): JsonField<String> = htmlBody
            ...
            @ExcludeMissing
            fun _textBody(): JsonField<String> = textBody

            @JsonProperty("to")
            @ExcludeMissing
            fun _to(): JsonField<String> = to

            @JsonProperty("bcc")
            @ExcludeMissing
            fun _bcc(): JsonField<String> = bcc

            @JsonProperty("cc")
            @ExcludeMissing
            fun _cc(): JsonField<String> = cc

            @JsonProperty("reply_to")
            @ExcludeMissing
            fun _replyTo(): JsonField<String> = replyTo
            ...
            fun validate(): MessageEmailContent =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(messageEmailContent: MessageEmailContent) =
                    apply {
                ...
                fun from(from: JsonField<String>) =
                    apply {
                        this.from = from
                    }
                ...
                fun htmlBody(htmlBody: JsonField<String>) =
                    apply {
                ...
                fun subjectLine(subjectLine: JsonField<String>) =
                    apply {
                ...
                fun textBody(textBody: JsonField<String>) =
                    apply {
                ...
                fun replyTo(replyTo: JsonField<String>) =
                    apply {
            ...
            override fun toString() = "MessageEmailContent{_typename=$_typename, from=$from, htmlBody=$htmlBody, subjectLine=$subjectLine, textBody=$textBody, to=$to, bcc=$bcc, cc=$cc, replyTo=$replyTo, additionalProperties=$additionalProperties}"
        }

        /** The contents of an SMS message */
        @NoAutoDetect
        class MessageSmsContent @JsonCreator private constructor(
            @JsonProperty("__typename") @ExcludeMissing private val _typename: JsonField<String> = JsonMissing.of(),
            @JsonProperty("body") @ExcludeMissing private val body: JsonField<String> = JsonMissing.of(),
            @JsonProperty("to") @ExcludeMissing private val to: JsonField<String> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
            ...
            @JsonProperty("body")
            @ExcludeMissing
            fun _body(): JsonField<String> = body
            ...
            fun validate(): MessageSmsContent =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(messageSmsContent: MessageSmsContent) =
                    apply {
                ...
                fun body(body: JsonField<String>) =
                    apply {
                        this.body = body
                    }
            ...
            override fun toString() = "MessageSmsContent{_typename=$_typename, body=$body, to=$to, additionalProperties=$additionalProperties}"
        }

        /** The contents of a push message */
        @NoAutoDetect
        class MessagePushContent @JsonCreator private constructor(
            @JsonProperty("token") @ExcludeMissing private val token: JsonField<String> = JsonMissing.of(),
            @JsonProperty("__typename") @ExcludeMissing private val _typename: JsonField<String> = JsonMissing.of(),
            @JsonProperty("body") @ExcludeMissing private val body: JsonField<String> = JsonMissing.of(),
            @JsonProperty("title") @ExcludeMissing private val title: JsonField<String> = JsonMissing.of(),
            @JsonProperty("data") @ExcludeMissing private val data: JsonField<InnerData> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
            ...
            @JsonProperty("data")
            @ExcludeMissing
            fun _data(): JsonField<InnerData> = data
            ...
            fun validate(): MessagePushContent =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(messagePushContent: MessagePushContent) =
                    apply {
                ...
                fun data(data: JsonField<InnerData>) =
                    apply {
                        this.data = data
                    }
            ...
            @NoAutoDetect
            class InnerData @JsonCreator private constructor(
                @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
                ...
                class Builder internal constructor() {
                    ...
                    @JvmSynthetic
                    internal fun from(innerData: InnerData) =
                        apply {
            ...
            override fun toString() = "MessagePushContent{token=$token, _typename=$_typename, body=$body, title=$title, data=$data, additionalProperties=$additionalProperties}"
        }

        /** The contents of a chat message */
        @NoAutoDetect
        class MessageChatContent @JsonCreator private constructor(
            @JsonProperty("__typename") @ExcludeMissing private val _typename: JsonField<String> = JsonMissing.of(),
            @JsonProperty("connection") @ExcludeMissing private val connection: JsonField<Connection> = JsonMissing.of(),
            @JsonProperty("template") @ExcludeMissing private val template: JsonField<Template> = JsonMissing.of(),
            ...
            fun validate(): MessageChatContent =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(messageChatContent: MessageChatContent) =
                    apply {
                ...
                fun template(template: JsonField<Template>) =
                    apply {
            ...
            @NoAutoDetect
            class Template @JsonCreator private constructor(
                @JsonProperty("blocks") @ExcludeMissing private val blocks: JsonField<List<Block>> = JsonMissing.of(),
                @JsonProperty("json_content") @ExcludeMissing private val jsonContent: JsonField<JsonContent> = JsonMissing.of(),
                @JsonProperty("summary") @ExcludeMissing private val summary: JsonField<String> = JsonMissing.of(),
                @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),

            ) {

                /** The structured blocks of the message */
                fun blocks(): Optional<List<Block>> = Optional.ofNullable(blocks.getNullable("blocks"))

                /** The JSON content of the message */
                fun jsonContent(): Optional<JsonContent> = Optional.ofNullable(jsonContent.getNullable("json_content"))

                fun summary(): Optional<String> = Optional.ofNullable(summary.getNullable("summary"))
                ...
                class Builder internal constructor() {
                    ...
                    @JvmSynthetic
                    internal fun from(template: Template) =
                        apply {
                    ...
                    /** The structured blocks of the message */
                    fun blocks(blocks: JsonField<List<Block>>) =
                        apply {
                    ...
                    fun addBlock(block: Block) =
                        apply {
                            blocks = (blocks ?: JsonField.of(mutableListOf())).also {
                                checkKnown("blocks", it).add(block)
                            }
                        }

                    /** The JSON content of the message */
                    fun jsonContent(jsonContent: JsonContent?) = jsonContent(JsonField.ofNullable(jsonContent))

                    /** The JSON content of the message */
                    fun jsonContent(jsonContent: Optional<JsonContent>) = jsonContent(jsonContent.getOrNull())

                    /** The JSON content of the message */
                    fun jsonContent(jsonContent: JsonField<JsonContent>) =
                        apply {
                ...
                @NoAutoDetect
                class Block @JsonCreator private constructor(
                    ...
                    override fun toString() = "Block{content=$content, name=$name, type=$type, additionalProperties=$additionalProperties}"
                }

                /** The JSON content of the message */
                @NoAutoDetect
                class JsonContent @JsonCreator private constructor(
                    @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
                    ...
                    class Builder internal constructor() {
                        ...
                        @JvmSynthetic
                        internal fun from(jsonContent: JsonContent) =
                            apply {
                    ...
                    override fun toString() = "JsonContent{additionalProperties=$additionalProperties}"
                }
                ...
                override fun toString() = "Template{blocks=$blocks, jsonContent=$jsonContent, summary=$summary, additionalProperties=$additionalProperties}"
            }
            ...
            override fun toString() = "MessageChatContent{_typename=$_typename, connection=$connection, template=$template, metadata=$metadata, additionalProperties=$additionalProperties}"
        }

        /** The contents of a message in an app feed */
        @NoAutoDetect
        class MessageInAppFeedContent @JsonCreator private constructor(
            @JsonProperty("__typename") @ExcludeMissing private val _typename: JsonField<String> = JsonMissing.of(),
            @JsonProperty("blocks") @ExcludeMissing private val blocks: JsonField<List<Block>> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
            ...
            fun validate(): MessageInAppFeedContent =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(messageInAppFeedContent: MessageInAppFeedContent) =
                    apply {
                        _typename = messageInAppFeedContent._typename
                        blocks = messageInAppFeedContent.blocks.map { it.toMutableList() }
                        additionalProperties = messageInAppFeedContent.additionalProperties.toMutableMap()
                    }
                ...
                fun addBlock(messageInAppFeedContent: Block.MessageInAppFeedContentBlock) = addBlock(Block.ofMessageInAppFeedContent(messageInAppFeedContent))

                /** A set of buttons in a message in an app feed */
                fun addBlock(messageInAppFeedButtonSet: Block.MessageInAppFeedButtonSetBlock) = addBlock(Block.ofMessageInAppFeedButtonSet(messageInAppFeedButtonSet))
            ...
            class Block private constructor(
                ...
                /** A content (text or markdown) block in a message in an app feed */
                fun messageInAppFeedContent(): Optional<MessageInAppFeedContentBlock> = Optional.ofNullable(messageInAppFeedContent)

                /** A set of buttons in a message in an app feed */
                fun messageInAppFeedButtonSet(): Optional<MessageInAppFeedButtonSetBlock> = Optional.ofNullable(messageInAppFeedButtonSet)
                ...
                /** A content (text or markdown) block in a message in an app feed */
                fun asMessageInAppFeedContent(): MessageInAppFeedContentBlock = messageInAppFeedContent.getOrThrow("messageInAppFeedContent")

                /** A set of buttons in a message in an app feed */
                fun asMessageInAppFeedButtonSet(): MessageInAppFeedButtonSetBlock = messageInAppFeedButtonSet.getOrThrow("messageInAppFeedButtonSet")
                ...
                fun <T> accept(visitor: Visitor<T>): T {
                  return when {
                      messageInAppFeedContent != null -> visitor.visitMessageInAppFeedContent(messageInAppFeedContent)
                      messageInAppFeedButtonSet != null -> visitor.visitMessageInAppFeedButtonSet(messageInAppFeedButtonSet)
                      else -> visitor.unknown(_json)
                  }
                }
                ...
                fun validate(): Block =
                    apply {
                        ...
                        accept(object : Visitor<Unit> {
                            override fun visitMessageInAppFeedContent(messageInAppFeedContent: MessageInAppFeedContentBlock) {
                              messageInAppFeedContent.validate()
                            }

                            override fun visitMessageInAppFeedButtonSet(messageInAppFeedButtonSet: MessageInAppFeedButtonSetBlock) {
                ...
                override fun toString(): String =
                    when {
                        messageInAppFeedContent != null -> "Block{messageInAppFeedContent=$messageInAppFeedContent}"
                        messageInAppFeedButtonSet != null -> "Block{messageInAppFeedButtonSet=$messageInAppFeedButtonSet}"
                ...
                companion object {
                    ...
                    /** A content (text or markdown) block in a message in an app feed */
                    @JvmStatic
                    fun ofMessageInAppFeedContent(messageInAppFeedContent: MessageInAppFeedContentBlock) = Block(messageInAppFeedContent = messageInAppFeedContent)

                    /** A set of buttons in a message in an app feed */
                    @JvmStatic
                    fun ofMessageInAppFeedButtonSet(messageInAppFeedButtonSet: MessageInAppFeedButtonSetBlock) = Block(messageInAppFeedButtonSet = messageInAppFeedButtonSet)
                }
                ...
                interface Visitor<out T> {
                    ...
                    /** A content (text or markdown) block in a message in an app feed */
                    fun visitMessageInAppFeedContent(messageInAppFeedContent: MessageInAppFeedContentBlock): T

                    /** A set of buttons in a message in an app feed */
                    fun visitMessageInAppFeedButtonSet(messageInAppFeedButtonSet: MessageInAppFeedButtonSetBlock): T
                ...
                internal class Deserializer : BaseDeserializer<Block>(Block::class) {
                    ...
                    override fun ObjectCodec.deserialize(node: JsonNode): Block {
                      ...
                      tryDeserialize(node, jacksonTypeRef<MessageInAppFeedContentBlock>()){ it.validate() }?.let {
                          return Block(messageInAppFeedContent = it, _json = json)
                      }
                      tryDeserialize(node, jacksonTypeRef<MessageInAppFeedButtonSetBlock>()){ it.validate() }?.let {
                ...
                internal class Serializer : BaseSerializer<Block>(Block::class) {
                    ...
                    override fun serialize(value: Block, generator: JsonGenerator, provider: SerializerProvider) {
                      when {
                          value.messageInAppFeedContent != null -> generator.writeObject(value.messageInAppFeedContent)
                          value.messageInAppFeedButtonSet != null -> generator.writeObject(value.messageInAppFeedButtonSet)
                          value._json != null -> generator.writeObject(value._json)
                          else -> throw IllegalStateException("Invalid Block")
                      }
                    }
                ...
                /** A content (text or markdown) block in a message in an app feed */
                @NoAutoDetect
                class MessageInAppFeedContentBlock @JsonCreator private constructor(
                    @JsonProperty("content") @ExcludeMissing private val content: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("name") @ExcludeMissing private val name: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("rendered") @ExcludeMissing private val rendered: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("type") @ExcludeMissing private val type: JsonField<Type> = JsonMissing.of(),
                    @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
                    ...
                    fun validate(): MessageInAppFeedContentBlock =
                        apply {
                            if (validated) {
                              return@apply
                            }
                    ...
                    class Builder internal constructor() {
                        ...
                        internal fun from(messageInAppFeedContentBlock: MessageInAppFeedContentBlock) =
                            apply {
                                ...
                                additionalProperties = messageInAppFeedContentBlock.additionalProperties.toMutableMap()
                            }
                        ...
                        fun rendered(rendered: JsonField<String>) =
                            apply {
                    ...
                    override fun toString() = "MessageInAppFeedContentBlock{content=$content, name=$name, rendered=$rendered, type=$type, additionalProperties=$additionalProperties}"
                }

                /** A set of buttons in a message in an app feed */
                @NoAutoDetect
                class MessageInAppFeedButtonSetBlock @JsonCreator private constructor(
                    @JsonProperty("buttons") @ExcludeMissing private val buttons: JsonField<List<Button>> = JsonMissing.of(),
                    @JsonProperty("name") @ExcludeMissing private val name: JsonField<String> = JsonMissing.of(),
                    @JsonProperty("type") @ExcludeMissing private val type: JsonField<Type> = JsonMissing.of(),
                    @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
                    ...
                    fun validate(): MessageInAppFeedButtonSetBlock =
                        apply {
                            if (validated) {
                              return@apply
                            }
                    ...
                    class Builder internal constructor() {
                        ...
                        internal fun from(messageInAppFeedButtonSetBlock: MessageInAppFeedButtonSetBlock) =
                            apply {
                                ...
                                additionalProperties = messageInAppFeedButtonSetBlock.additionalProperties.toMutableMap()
                            }

                        fun buttons(buttons: List<Button>) = buttons(JsonField.of(buttons))

                        fun buttons(buttons: JsonField<List<Button>>) =
                            apply {
                        ...
                        fun addButton(button: Button) =
                            apply {
                                buttons = (buttons ?: JsonField.of(mutableListOf())).also {
                    ...
                    @NoAutoDetect
                    class Button @JsonCreator private constructor(
                        @JsonProperty("action") @ExcludeMissing private val action: JsonField<String> = JsonMissing.of(),
                        ...
                        class Builder internal constructor() {
                            ...
                            @JvmSynthetic
                            internal fun from(button: Button) =
                                apply {
                            ...
                            fun action(action: JsonField<String>) =
                                apply {
                                    this.action = action
                                }
                        ...
                        override fun toString() = "Button{action=$action, label=$label, name=$name, additionalProperties=$additionalProperties}"
                    }
                    ...
                    override fun toString() = "MessageInAppFeedButtonSetBlock{buttons=$buttons, name=$name, type=$type, additionalProperties=$additionalProperties}"
                }
            }
            ...
            override fun toString() = "MessageInAppFeedContent{_typename=$_typename, blocks=$blocks, additionalProperties=$additionalProperties}"
        }
    }
    ...
    override fun toString() = "MessageGetContentResponse{_typename=$_typename, data=$data, insertedAt=$insertedAt, messageId=$messageId, additionalProperties=$additionalProperties}"
}
