...
class Message @JsonCreator private constructor(
    ...
    @JsonProperty("actors") @ExcludeMissing private val actors: JsonField<List<Actor>> = JsonMissing.of(),
    ...
    @JsonProperty("clicked_at") @ExcludeMissing private val clickedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
    @JsonProperty("data") @ExcludeMissing private val data: JsonField<Data> = JsonMissing.of(),
    @JsonProperty("engagement_statuses") @ExcludeMissing private val engagementStatuses: JsonField<List<EngagementStatus>> = JsonMissing.of(),
    @JsonProperty("inserted_at") @ExcludeMissing private val insertedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
    @JsonProperty("interacted_at") @ExcludeMissing private val interactedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
    @JsonProperty("link_clicked_at") @ExcludeMissing private val linkClickedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
    @JsonProperty("metadata") @ExcludeMissing private val metadata: JsonField<Metadata> = JsonMissing.of(),
    @JsonProperty("read_at") @ExcludeMissing private val readAt: JsonField<OffsetDateTime> = JsonMissing.of(),
    ...
    @JsonProperty("seen_at") @ExcludeMissing private val seenAt: JsonField<OffsetDateTime> = JsonMissing.of(),
    ...
    fun clickedAt(): Optional<OffsetDateTime> = Optional.ofNullable(clickedAt.getNullable("clicked_at"))

    /** Additional message data */
    fun data(): Optional<Data> = Optional.ofNullable(data.getNullable("data"))

    /** List of engagement statuses */
    fun engagementStatuses(): Optional<List<EngagementStatus>> = Optional.ofNullable(engagementStatuses.getNullable("engagement_statuses"))
    ...
    fun interactedAt(): Optional<OffsetDateTime> = Optional.ofNullable(interactedAt.getNullable("interacted_at"))

    /** Timestamp when a link in the message was clicked */
    fun linkClickedAt(): Optional<OffsetDateTime> = Optional.ofNullable(linkClickedAt.getNullable("link_clicked_at"))
    ...
    @JsonProperty("actors")
    @ExcludeMissing
    fun _actors(): JsonField<List<Actor>> = actors
    ...
    class Builder internal constructor() {
        ...
        /** A list of actor representations associated with the message (up to 10) */
        fun actors(actors: JsonField<List<Actor>>) =
            apply {
        ...
        fun addActor(objectReference: Actor.ObjectReference) = addActor(Actor.ofObjectReference(objectReference))
        ...
        /** Timestamp when message was clicked */
        fun clickedAt(clickedAt: JsonField<OffsetDateTime>) =
            apply {
        ...
        /** List of engagement statuses */
        fun engagementStatuses(engagementStatuses: List<EngagementStatus>) = engagementStatuses(JsonField.of(engagementStatuses))

        /** List of engagement statuses */
        fun engagementStatuses(engagementStatuses: JsonField<List<EngagementStatus>>) =
            apply {
        ...
        fun addEngagementStatus(engagementStatus: EngagementStatus) =
            apply {
                engagementStatuses = (engagementStatuses ?: JsonField.of(mutableListOf())).also {
        ...
        /** Timestamp when message was interacted with */
        fun interactedAt(interactedAt: OffsetDateTime?) = interactedAt(JsonField.ofNullable(interactedAt))

        /** Timestamp when message was interacted with */
        fun interactedAt(interactedAt: Optional<OffsetDateTime>) = interactedAt(interactedAt.getOrNull())

        /** Timestamp when message was interacted with */
        fun interactedAt(interactedAt: JsonField<OffsetDateTime>) =
            apply {
                this.interactedAt = interactedAt
            }

        /** Timestamp when a link in the message was clicked */
        fun linkClickedAt(linkClickedAt: OffsetDateTime?) = linkClickedAt(JsonField.ofNullable(linkClickedAt))

        /** Timestamp when a link in the message was clicked */
        fun linkClickedAt(linkClickedAt: Optional<OffsetDateTime>) = linkClickedAt(linkClickedAt.getOrNull())

        /** Timestamp when a link in the message was clicked */
        fun linkClickedAt(linkClickedAt: JsonField<OffsetDateTime>) =
            apply {
        ...
        /** Timestamp when message was read */
        fun readAt(readAt: JsonField<OffsetDateTime>) =
            apply {
                this.readAt = readAt
            }
        ...
        /** Timestamp when message was seen */
        fun seenAt(seenAt: JsonField<OffsetDateTime>) =
            apply {
                this.seenAt = seenAt
            }
    ...
    class Actor private constructor(
        ...
        companion object {
            ...
            /** A user identifier */
            @JvmStatic
            fun ofString(string: String) = Actor(string = string)

            /** An object reference to a recipient */
            @JvmStatic
            fun ofObjectReference(objectReference: ObjectReference) = Actor(objectReference = objectReference)
        }

        /**
         * An interface that defines how to map each variant of [Actor] to a value of type
         * [T].
         */
        interface Visitor<out T> {
             ...
             *
             * An instance of [Actor] can contain an unknown variant if it was deserialized
        ...
        internal class Serializer : BaseSerializer<Actor>(Actor::class) {
            ...
            override fun serialize(value: Actor, generator: JsonGenerator, provider: SerializerProvider) {
              when {
