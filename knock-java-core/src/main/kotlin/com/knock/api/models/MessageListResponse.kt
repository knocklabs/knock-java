...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(messageListResponse: MessageListResponse) = apply {
            ...
            _typename = messageListResponse._typename
            actors = messageListResponse.actors.map { it.toMutableList() }
            archivedAt = messageListResponse.archivedAt
            channelId = messageListResponse.channelId
            clickedAt = messageListResponse.clickedAt
            data = messageListResponse.data
            engagementStatuses = messageListResponse.engagementStatuses.map { it.toMutableList() }
            insertedAt = messageListResponse.insertedAt
            interactedAt = messageListResponse.interactedAt
            linkClickedAt = messageListResponse.linkClickedAt
            metadata = messageListResponse.metadata
            readAt = messageListResponse.readAt
            recipient = messageListResponse.recipient
            scheduledAt = messageListResponse.scheduledAt
            seenAt = messageListResponse.seenAt
            source = messageListResponse.source
            status = messageListResponse.status
            tenant = messageListResponse.tenant
            updatedAt = messageListResponse.updatedAt
            workflow = messageListResponse.workflow
