...
private constructor(
    ...
    companion object {
         ...
         * [MessageBatchMarkAsInteractedParams].
         *
         * The following fields are required:
         * ```java
         * .messageIds()
    ...
    /** A builder for [MessageBatchMarkAsInteractedParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageBatchMarkAsInteractedParams: MessageBatchMarkAsInteractedParams) =
            apply {
                body = messageBatchMarkAsInteractedParams.body.toBuilder()
                additionalHeaders = messageBatchMarkAsInteractedParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    messageBatchMarkAsInteractedParams.additionalQueryParams.toBuilder()
            }
        ...
        fun build(): MessageBatchMarkAsInteractedParams =
            MessageBatchMarkAsInteractedParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchMarkAsInteractedParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "MessageBatchMarkAsInteractedParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
