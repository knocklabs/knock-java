...
class BulkDeleteParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.tenantIds.let {
          queryParams.put(
            "tenant_ids[]", it.map(Any::toString)
          )
      }
    ...
    class Builder internal constructor() {
        ...
        /** The IDs of the tenants to delete */
        fun tenantIds(tenantIds: List<String>) =
            apply {
                this.tenantIds = tenantIds.toMutableList()
            }

        /** The IDs of the tenants to delete */
        fun addTenantId(tenantId: String) =
            apply {
    ...
    override fun toString() = "BulkDeleteParams{tenantIds=$tenantIds, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
