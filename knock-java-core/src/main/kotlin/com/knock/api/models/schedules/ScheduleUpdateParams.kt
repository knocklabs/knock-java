...
/** Update schedules */
class ScheduleUpdateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("schedule_ids") @ExcludeMissing private val scheduleIds: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("actor") @ExcludeMissing private val actor: JsonField<RecipientRequest> = JsonMissing.of(),
        @JsonProperty("data") @ExcludeMissing private val data: JsonField<Data> = JsonMissing.of(),
        @JsonProperty("ending_at") @ExcludeMissing private val endingAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("repeats") @ExcludeMissing private val repeats: JsonField<List<ScheduleRepeatRule>> = JsonMissing.of(),
        @JsonProperty("scheduled_at") @ExcludeMissing private val scheduledAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("tenant") @ExcludeMissing private val tenant: JsonField<InlineTenantRequest> = JsonMissing.of(),
        ...
        fun endingAt(): Optional<OffsetDateTime> = Optional.ofNullable(endingAt.getNullable("ending_at"))

        fun repeats(): Optional<List<ScheduleRepeatRule>> = Optional.ofNullable(repeats.getNullable("repeats"))

        fun scheduledAt(): Optional<OffsetDateTime> = Optional.ofNullable(scheduledAt.getNullable("scheduled_at"))

        /** An inline tenant request */
        fun tenant(): Optional<InlineTenantRequest> = Optional.ofNullable(tenant.getNullable("tenant"))
        ...
        @JsonProperty("actor")
        @ExcludeMissing
        fun _actor(): JsonField<RecipientRequest> = actor
        ...
        class Builder internal constructor() {
            ...
            fun scheduleIds(scheduleIds: JsonField<List<String>>) =
                apply {
                    this.scheduleIds = scheduleIds.map { it.toMutableList() }
                }

            fun addScheduleId(scheduleId: String) =
                apply {
                    scheduleIds = (scheduleIds ?: JsonField.of(mutableListOf())).also {
             ...
             * determined by the presence of a `collection` property.
             */
            fun actor(actor: JsonField<RecipientRequest>) =
                apply {
                    this.actor = actor
                }
             ...
             */
            fun actor(inlineIdentifyUser: InlineIdentifyUserRequest) = actor(RecipientRequest.ofInlineIdentifyUser(inlineIdentifyUser))

            /** Inline identifies a custom object belonging to a collection */
            fun actor(inlineObject: InlineObjectRequest) = actor(RecipientRequest.ofInlineObject(inlineObject))
            ...
            fun endingAt(endingAt: JsonField<OffsetDateTime>) =
                apply {
            ...
            fun scheduledAt(scheduledAt: OffsetDateTime?) = scheduledAt(JsonField.ofNullable(scheduledAt))

            fun scheduledAt(scheduledAt: Optional<OffsetDateTime>) = scheduledAt(scheduledAt.getOrNull())

            fun scheduledAt(scheduledAt: JsonField<OffsetDateTime>) =
                apply {
            ...
            /** An inline tenant request */
            fun tenant(tenant: JsonField<InlineTenantRequest>) =
                apply {
                    this.tenant = tenant
                }
            ...
            fun tenant(tenantRequest: TenantRequest) = tenant(InlineTenantRequest.ofTenantRequest(tenantRequest))
        ...
        override fun toString() = "Body{scheduleIds=$scheduleIds, actor=$actor, data=$data, endingAt=$endingAt, repeats=$repeats, scheduledAt=$scheduledAt, tenant=$tenant, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scheduleUpdateParams: ScheduleUpdateParams) =
            apply {
        ...
        fun scheduleIds(scheduleIds: List<String>) =
            apply {
         ...
         * determined by the presence of a `collection` property.
         */
        fun actor(actor: RecipientRequest?) =
            apply {
                body.actor(actor)
            }
        ...
        fun endingAt(endingAt: OffsetDateTime?) =
            apply {
                body.endingAt(endingAt)
            }
        ...
        fun repeats(repeats: List<ScheduleRepeatRule>) =
            apply {
        ...
        /** An inline tenant request */
        fun tenant(tenant: InlineTenantRequest?) =
            apply {
                body.tenant(tenant)
            }
    ...
    override fun toString() = "ScheduleUpdateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
