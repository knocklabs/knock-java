...
@NoAutoDetect
class MessageMarkAsSeenResponse
@JsonCreator
private constructor(
    ...
    fun validate(): MessageMarkAsSeenResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageMarkAsSeenResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MessageMarkAsSeenResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageMarkAsSeenResponse: MessageMarkAsSeenResponse) = apply {
            id = messageMarkAsSeenResponse.id
            _typename = messageMarkAsSeenResponse._typename
            actors = messageMarkAsSeenResponse.actors.map { it.toMutableList() }
            archivedAt = messageMarkAsSeenResponse.archivedAt
            channelId = messageMarkAsSeenResponse.channelId
            clickedAt = messageMarkAsSeenResponse.clickedAt
            data = messageMarkAsSeenResponse.data
            engagementStatuses =
                messageMarkAsSeenResponse.engagementStatuses.map { it.toMutableList() }
            insertedAt = messageMarkAsSeenResponse.insertedAt
            interactedAt = messageMarkAsSeenResponse.interactedAt
            linkClickedAt = messageMarkAsSeenResponse.linkClickedAt
            metadata = messageMarkAsSeenResponse.metadata
            readAt = messageMarkAsSeenResponse.readAt
            recipient = messageMarkAsSeenResponse.recipient
            scheduledAt = messageMarkAsSeenResponse.scheduledAt
            seenAt = messageMarkAsSeenResponse.seenAt
            source = messageMarkAsSeenResponse.source
            status = messageMarkAsSeenResponse.status
            tenant = messageMarkAsSeenResponse.tenant
            updatedAt = messageMarkAsSeenResponse.updatedAt
            workflow = messageMarkAsSeenResponse.workflow
            additionalProperties = messageMarkAsSeenResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): MessageMarkAsSeenResponse =
