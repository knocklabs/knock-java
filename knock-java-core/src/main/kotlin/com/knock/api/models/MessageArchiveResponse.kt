...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(messageArchiveResponse: MessageArchiveResponse) = apply {
            id = messageArchiveResponse.id
            _typename = messageArchiveResponse._typename
            actors = messageArchiveResponse.actors.map { it.toMutableList() }
            archivedAt = messageArchiveResponse.archivedAt
            channelId = messageArchiveResponse.channelId
            clickedAt = messageArchiveResponse.clickedAt
            data = messageArchiveResponse.data
            engagementStatuses =
                messageArchiveResponse.engagementStatuses.map { it.toMutableList() }
            insertedAt = messageArchiveResponse.insertedAt
            interactedAt = messageArchiveResponse.interactedAt
            linkClickedAt = messageArchiveResponse.linkClickedAt
            metadata = messageArchiveResponse.metadata
            readAt = messageArchiveResponse.readAt
            recipient = messageArchiveResponse.recipient
            scheduledAt = messageArchiveResponse.scheduledAt
            seenAt = messageArchiveResponse.seenAt
            source = messageArchiveResponse.source
            status = messageArchiveResponse.status
            tenant = messageArchiveResponse.tenant
            updatedAt = messageArchiveResponse.updatedAt
            workflow = messageArchiveResponse.workflow
