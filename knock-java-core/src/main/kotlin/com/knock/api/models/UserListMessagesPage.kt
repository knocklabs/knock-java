...
private constructor(
    ...
    class AutoPager(private val firstPage: UserListMessagesPage) :
        Iterable<UserListMessagesResponse> {

        override fun iterator(): Iterator<UserListMessagesResponse> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
        ...
        fun stream(): Stream<UserListMessagesResponse> {
