...
@NoAutoDetect
class UserBulkIdentifyResponse
@JsonCreator
private constructor(
    ...
    fun validate(): UserBulkIdentifyResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserBulkIdentifyResponse].
         *
    ...
    /** A builder for [UserBulkIdentifyResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userBulkIdentifyResponse: UserBulkIdentifyResponse) = apply {
            id = userBulkIdentifyResponse.id
            _typename = userBulkIdentifyResponse._typename
            estimatedTotalRows = userBulkIdentifyResponse.estimatedTotalRows
            insertedAt = userBulkIdentifyResponse.insertedAt
            name = userBulkIdentifyResponse.name
            processedRows = userBulkIdentifyResponse.processedRows
            status = userBulkIdentifyResponse.status
            successCount = userBulkIdentifyResponse.successCount
            updatedAt = userBulkIdentifyResponse.updatedAt
            completedAt = userBulkIdentifyResponse.completedAt
            errorCount = userBulkIdentifyResponse.errorCount
            errorItems = userBulkIdentifyResponse.errorItems.map { it.toMutableList() }
            failedAt = userBulkIdentifyResponse.failedAt
            startedAt = userBulkIdentifyResponse.startedAt
            additionalProperties = userBulkIdentifyResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): UserBulkIdentifyResponse =
    ...
    override fun toString() =
        "UserBulkIdentifyResponse{id=$id, _typename=$_typename, estimatedTotalRows=$estimatedTotalRows, insertedAt=$insertedAt, name=$name, processedRows=$processedRows, status=$status, successCount=$successCount, updatedAt=$updatedAt, completedAt=$completedAt, errorCount=$errorCount, errorItems=$errorItems, failedAt=$failedAt, startedAt=$startedAt, additionalProperties=$additionalProperties}"
}
