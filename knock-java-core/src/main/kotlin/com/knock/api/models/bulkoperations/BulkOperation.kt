...
package com.knock.api.models.bulkoperations
...
@NoAutoDetect
class BulkOperation @JsonCreator private constructor(
    @JsonProperty("id") @ExcludeMissing private val id: JsonField<String> = JsonMissing.of(),
    @JsonProperty("__typename") @ExcludeMissing private val _typename: JsonField<String> = JsonMissing.of(),
    @JsonProperty("estimated_total_rows") @ExcludeMissing private val estimatedTotalRows: JsonField<Long> = JsonMissing.of(),
    @JsonProperty("inserted_at") @ExcludeMissing private val insertedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
    @JsonProperty("name") @ExcludeMissing private val name: JsonField<String> = JsonMissing.of(),
    @JsonProperty("processed_rows") @ExcludeMissing private val processedRows: JsonField<Long> = JsonMissing.of(),
    @JsonProperty("status") @ExcludeMissing private val status: JsonField<Status> = JsonMissing.of(),
    @JsonProperty("success_count") @ExcludeMissing private val successCount: JsonField<Long> = JsonMissing.of(),
    @JsonProperty("updated_at") @ExcludeMissing private val updatedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
    @JsonProperty("completed_at") @ExcludeMissing private val completedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
    @JsonProperty("error_count") @ExcludeMissing private val errorCount: JsonField<Long> = JsonMissing.of(),
    @JsonProperty("error_items") @ExcludeMissing private val errorItems: JsonField<List<ErrorItem>> = JsonMissing.of(),
    @JsonProperty("failed_at") @ExcludeMissing private val failedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
    @JsonProperty("started_at") @ExcludeMissing private val startedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
    ...
    fun completedAt(): Optional<OffsetDateTime> = Optional.ofNullable(completedAt.getNullable("completed_at"))

    fun errorCount(): Optional<Long> = Optional.ofNullable(errorCount.getNullable("error_count"))

    /** A list of items that failed to be processed */
    fun errorItems(): Optional<List<ErrorItem>> = Optional.ofNullable(errorItems.getNullable("error_items"))

    fun failedAt(): Optional<OffsetDateTime> = Optional.ofNullable(failedAt.getNullable("failed_at"))

    fun startedAt(): Optional<OffsetDateTime> = Optional.ofNullable(startedAt.getNullable("started_at"))
    ...
    @ExcludeMissing
    fun _errorCount(): JsonField<Long> = errorCount
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bulkOperation: BulkOperation) =
            apply {
                id = bulkOperation.id
        ...
        fun estimatedTotalRows(estimatedTotalRows: Long) = estimatedTotalRows(JsonField.of(estimatedTotalRows))

        fun estimatedTotalRows(estimatedTotalRows: JsonField<Long>) =
            apply {
        ...
        fun processedRows(processedRows: JsonField<Long>) =
            apply {
        ...
        fun successCount(successCount: JsonField<Long>) =
            apply {
        ...
        fun completedAt(completedAt: OffsetDateTime?) = completedAt(JsonField.ofNullable(completedAt))

        fun completedAt(completedAt: Optional<OffsetDateTime>) = completedAt(completedAt.getOrNull())

        fun completedAt(completedAt: JsonField<OffsetDateTime>) =
            apply {
        ...
        fun errorCount(errorCount: JsonField<Long>) =
            apply {
        ...
        /** A list of items that failed to be processed */
        fun errorItems(errorItems: JsonField<List<ErrorItem>>) =
            apply {
                this.errorItems = errorItems.map { it.toMutableList() }
            }

        /** A list of items that failed to be processed */
        fun addErrorItem(errorItem: ErrorItem) =
            apply {
                errorItems = (errorItems ?: JsonField.of(mutableListOf())).also {
        ...
        fun failedAt(failedAt: JsonField<OffsetDateTime>) =
            apply {
        ...
        fun startedAt(startedAt: JsonField<OffsetDateTime>) =
            apply {
    ...
    @NoAutoDetect
    class ErrorItem @JsonCreator private constructor(
        @JsonProperty("id") @ExcludeMissing private val id: JsonField<String> = JsonMissing.of(),
        ...
        fun collection(): Optional<String> = Optional.ofNullable(collection.getNullable("collection"))
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(errorItem: ErrorItem) =
                apply {
                    id = errorItem.id
        ...
        override fun toString() = "ErrorItem{id=$id, collection=$collection, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "BulkOperation{id=$id, _typename=$_typename, estimatedTotalRows=$estimatedTotalRows, insertedAt=$insertedAt, name=$name, processedRows=$processedRows, status=$status, successCount=$successCount, updatedAt=$updatedAt, completedAt=$completedAt, errorCount=$errorCount, errorItems=$errorItems, failedAt=$failedAt, startedAt=$startedAt, additionalProperties=$additionalProperties}"
}
