...
/** Add members */
class AudienceAddMembersParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(audienceAddMembersParams: AudienceAddMembersParams) =
            apply {
    ...
    override fun toString() = "AudienceAddMembersParams{key=$key, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
