...
@NoAutoDetect
class UserBulkSetPreferencesResponse
@JsonCreator
private constructor(
    ...
    fun validate(): UserBulkSetPreferencesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [UserBulkSetPreferencesResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userBulkSetPreferencesResponse: UserBulkSetPreferencesResponse) = apply {
            id = userBulkSetPreferencesResponse.id
            _typename = userBulkSetPreferencesResponse._typename
            estimatedTotalRows = userBulkSetPreferencesResponse.estimatedTotalRows
            insertedAt = userBulkSetPreferencesResponse.insertedAt
            name = userBulkSetPreferencesResponse.name
            processedRows = userBulkSetPreferencesResponse.processedRows
            status = userBulkSetPreferencesResponse.status
            successCount = userBulkSetPreferencesResponse.successCount
            updatedAt = userBulkSetPreferencesResponse.updatedAt
            completedAt = userBulkSetPreferencesResponse.completedAt
            errorCount = userBulkSetPreferencesResponse.errorCount
            errorItems = userBulkSetPreferencesResponse.errorItems.map { it.toMutableList() }
            failedAt = userBulkSetPreferencesResponse.failedAt
            startedAt = userBulkSetPreferencesResponse.startedAt
            additionalProperties =
                userBulkSetPreferencesResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): UserBulkSetPreferencesResponse =
            UserBulkSetPreferencesResponse(
                checkRequired("id", id),
