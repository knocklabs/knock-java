...
/** Identify user */
class UserUpdateParams private constructor(
    ...
    fun _additionalBodyProperties(): Map<String, JsonValue> = identifyUserRequest._additionalProperties()
    ...
    @JvmSynthetic
    internal fun _body(): IdentifyUserRequest = identifyUserRequest
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userUpdateParams: UserUpdateParams) =
            apply {
    ...
    override fun toString() = "UserUpdateParams{userId=$userId, identifyUserRequest=$identifyUserRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
