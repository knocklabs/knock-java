...
@NoAutoDetect
class TenantBulkDeleteResponse
@JsonCreator
private constructor(
    ...
    fun validate(): TenantBulkDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TenantBulkDeleteResponse].
         *
    ...
    /** A builder for [TenantBulkDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tenantBulkDeleteResponse: TenantBulkDeleteResponse) = apply {
            id = tenantBulkDeleteResponse.id
            _typename = tenantBulkDeleteResponse._typename
            estimatedTotalRows = tenantBulkDeleteResponse.estimatedTotalRows
            insertedAt = tenantBulkDeleteResponse.insertedAt
            name = tenantBulkDeleteResponse.name
            processedRows = tenantBulkDeleteResponse.processedRows
            status = tenantBulkDeleteResponse.status
            successCount = tenantBulkDeleteResponse.successCount
            updatedAt = tenantBulkDeleteResponse.updatedAt
            completedAt = tenantBulkDeleteResponse.completedAt
            errorCount = tenantBulkDeleteResponse.errorCount
            errorItems = tenantBulkDeleteResponse.errorItems.map { it.toMutableList() }
            failedAt = tenantBulkDeleteResponse.failedAt
            startedAt = tenantBulkDeleteResponse.startedAt
            additionalProperties = tenantBulkDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): TenantBulkDeleteResponse =
    ...
    override fun toString() =
        "TenantBulkDeleteResponse{id=$id, _typename=$_typename, estimatedTotalRows=$estimatedTotalRows, insertedAt=$insertedAt, name=$name, processedRows=$processedRows, status=$status, successCount=$successCount, updatedAt=$updatedAt, completedAt=$completedAt, errorCount=$errorCount, errorItems=$errorItems, failedAt=$failedAt, startedAt=$startedAt, additionalProperties=$additionalProperties}"
}
