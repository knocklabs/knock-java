...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TenantBulkSetParams].
         *
         * The following fields are required:
         * ```java
         * .tenants()
    ...
    /** A builder for [TenantBulkSetParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tenantBulkSetParams: TenantBulkSetParams) = apply {
            body = tenantBulkSetParams.body.toBuilder()
            additionalHeaders = tenantBulkSetParams.additionalHeaders.toBuilder()
            additionalQueryParams = tenantBulkSetParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TenantBulkSetParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "TenantBulkSetParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
