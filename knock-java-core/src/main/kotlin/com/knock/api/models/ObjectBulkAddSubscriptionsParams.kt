 ...
 * it will be updated.
 */
class ObjectBulkAddSubscriptionsParams
private constructor(
    ...
    companion object {
         ...
         * [ObjectBulkAddSubscriptionsParams].
         *
         * The following fields are required:
         * ```java
         * .collection()
    ...
    /** A builder for [ObjectBulkAddSubscriptionsParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(objectBulkAddSubscriptionsParams: ObjectBulkAddSubscriptionsParams) =
            apply {
                collection = objectBulkAddSubscriptionsParams.collection
                body = objectBulkAddSubscriptionsParams.body.toBuilder()
                additionalHeaders = objectBulkAddSubscriptionsParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    objectBulkAddSubscriptionsParams.additionalQueryParams.toBuilder()
            }
        ...
        fun build(): ObjectBulkAddSubscriptionsParams =
            ObjectBulkAddSubscriptionsParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ObjectBulkAddSubscriptionsParams && collection == other.collection && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(collection, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ObjectBulkAddSubscriptionsParams{collection=$collection, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
