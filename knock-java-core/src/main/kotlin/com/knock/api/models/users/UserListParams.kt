...
/** List users */
class UserListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userListParams: UserListParams) =
            apply {
    ...
    override fun toString() = "UserListParams{after=$after, before=$before, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
