...
@NoAutoDetect
class MessageMarkAsUnreadResponse
@JsonCreator
private constructor(
    ...
    fun validate(): MessageMarkAsUnreadResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageMarkAsUnreadResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MessageMarkAsUnreadResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageMarkAsUnreadResponse: MessageMarkAsUnreadResponse) = apply {
            id = messageMarkAsUnreadResponse.id
            _typename = messageMarkAsUnreadResponse._typename
            actors = messageMarkAsUnreadResponse.actors.map { it.toMutableList() }
            archivedAt = messageMarkAsUnreadResponse.archivedAt
            channelId = messageMarkAsUnreadResponse.channelId
            clickedAt = messageMarkAsUnreadResponse.clickedAt
            data = messageMarkAsUnreadResponse.data
            engagementStatuses =
                messageMarkAsUnreadResponse.engagementStatuses.map { it.toMutableList() }
            insertedAt = messageMarkAsUnreadResponse.insertedAt
            interactedAt = messageMarkAsUnreadResponse.interactedAt
            linkClickedAt = messageMarkAsUnreadResponse.linkClickedAt
            metadata = messageMarkAsUnreadResponse.metadata
            readAt = messageMarkAsUnreadResponse.readAt
            recipient = messageMarkAsUnreadResponse.recipient
            scheduledAt = messageMarkAsUnreadResponse.scheduledAt
            seenAt = messageMarkAsUnreadResponse.seenAt
            source = messageMarkAsUnreadResponse.source
            status = messageMarkAsUnreadResponse.status
            tenant = messageMarkAsUnreadResponse.tenant
            updatedAt = messageMarkAsUnreadResponse.updatedAt
            workflow = messageMarkAsUnreadResponse.workflow
            additionalProperties = messageMarkAsUnreadResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): MessageMarkAsUnreadResponse =
