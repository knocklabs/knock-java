 ...
 */
class UserMergeParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("from_user_id") @ExcludeMissing private val fromUserId: JsonField<String> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            /** The user ID to merge from */
            fun fromUserId(fromUserId: JsonField<String>) =
                apply {
        ...
        override fun toString() = "Body{fromUserId=$fromUserId, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userMergeParams: UserMergeParams) =
            apply {
        ...
        /** The user ID to merge from */
        fun fromUserId(fromUserId: String) =
            apply {
    ...
    override fun toString() = "UserMergeParams{userId=$userId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
