...
@NoAutoDetect
class ProviderMsTeamCheckAuthResponse
@JsonCreator
private constructor(
    ...
    fun validate(): ProviderMsTeamCheckAuthResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [ProviderMsTeamCheckAuthResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(providerMsTeamCheckAuthResponse: ProviderMsTeamCheckAuthResponse) =
            apply {
                connection = providerMsTeamCheckAuthResponse.connection
                additionalProperties =
                    providerMsTeamCheckAuthResponse.additionalProperties.toMutableMap()
            }
        ...
        fun build(): ProviderMsTeamCheckAuthResponse =
            ProviderMsTeamCheckAuthResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ProviderMsTeamCheckAuthResponse && connection == other.connection && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ProviderMsTeamCheckAuthResponse{connection=$connection, additionalProperties=$additionalProperties}"
}
