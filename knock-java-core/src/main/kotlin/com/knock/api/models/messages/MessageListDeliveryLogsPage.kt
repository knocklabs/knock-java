...
/** List delivery logs */
class MessageListDeliveryLogsPage private constructor(
    ...
    override fun toString() = "MessageListDeliveryLogsPage{messagesService=$messagesService, params=$params, response=$response}"
    ...
    companion object {
        ...
        @JvmStatic
        fun of(messagesService: MessageService, params: MessageListDeliveryLogsParams, response: Response) =
    ...
    class AutoPager(
        private val firstPage: MessageListDeliveryLogsPage,

    ) : Iterable<MessageDeliveryLog> {

        override fun iterator(): Iterator<MessageDeliveryLog> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
