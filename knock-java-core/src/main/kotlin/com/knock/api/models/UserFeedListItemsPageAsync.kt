...
class UserFeedListItemsPageAsync
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is UserFeedListItemsPageAsync && feedsService == other.feedsService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(feedsService, params, response) /* spotless:on */

    override fun toString() =
        "UserFeedListItemsPageAsync{feedsService=$feedsService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<UserFeedListItemsPageAsync>> {
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = UserFeedListItemsPageAsync(feedsService, params, response)
    }
    ...
    class AutoPager(private val firstPage: UserFeedListItemsPageAsync) {

        fun forEach(
            action: Predicate<UserFeedListItemsResponse>,
            executor: Executor,
        ): CompletableFuture<Void> {
            fun CompletableFuture<Optional<UserFeedListItemsPageAsync>>.forEach(
                action: (UserFeedListItemsResponse) -> Boolean,
                executor: Executor,
            ): CompletableFuture<Void> =
                thenComposeAsync(
                    { page ->
        ...
        fun toList(executor: Executor): CompletableFuture<List<UserFeedListItemsResponse>> {
            val values = mutableListOf<UserFeedListItemsResponse>()
