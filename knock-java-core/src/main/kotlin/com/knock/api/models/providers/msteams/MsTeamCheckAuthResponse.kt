...
@NoAutoDetect
class MsTeamCheckAuthResponse @JsonCreator private constructor(
    ...
    fun validate(): MsTeamCheckAuthResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(msTeamCheckAuthResponse: MsTeamCheckAuthResponse) =
            apply {
    ...
    override fun toString() = "MsTeamCheckAuthResponse{connection=$connection, additionalProperties=$additionalProperties}"
}
