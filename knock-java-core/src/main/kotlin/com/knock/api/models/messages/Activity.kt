...
@NoAutoDetect
class Activity @JsonCreator private constructor(
    ...
    fun insertedAt(): Optional<OffsetDateTime> = Optional.ofNullable(insertedAt.getNullable("inserted_at"))

    /** A recipient, which is either a user or an object */
    fun recipient(): Optional<Recipient> = Optional.ofNullable(recipient.getNullable("recipient"))

    fun updatedAt(): Optional<OffsetDateTime> = Optional.ofNullable(updatedAt.getNullable("updated_at"))
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(activity: Activity) =
            apply {
                id = activity.id
    ...
    override fun toString() = "Activity{id=$id, _typename=$_typename, actor=$actor, data=$data, insertedAt=$insertedAt, recipient=$recipient, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
