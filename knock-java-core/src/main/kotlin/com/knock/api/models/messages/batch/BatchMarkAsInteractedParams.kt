...
class BatchMarkAsInteractedParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("message_ids") @ExcludeMissing private val messageIds: JsonField<List<String>> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            /** The message IDs to update */
            fun messageIds(messageIds: JsonField<List<String>>) =
                apply {
            ...
            fun addMessageId(messageId: String) =
                apply {
                    messageIds = (messageIds ?: JsonField.of(mutableListOf())).also {
        ...
        override fun toString() = "Body{messageIds=$messageIds, metadata=$metadata, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchMarkAsInteractedParams: BatchMarkAsInteractedParams) =
            apply {
    ...
    override fun toString() = "BatchMarkAsInteractedParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
