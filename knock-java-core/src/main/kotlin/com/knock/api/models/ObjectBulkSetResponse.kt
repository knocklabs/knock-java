...
private constructor(
    ...
    fun validate(): ObjectBulkSetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ObjectBulkSetResponse].
         *
    ...
    /** A builder for [ObjectBulkSetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(objectBulkSetResponse: ObjectBulkSetResponse) = apply {
            id = objectBulkSetResponse.id
            _typename = objectBulkSetResponse._typename
            estimatedTotalRows = objectBulkSetResponse.estimatedTotalRows
            insertedAt = objectBulkSetResponse.insertedAt
            name = objectBulkSetResponse.name
            processedRows = objectBulkSetResponse.processedRows
            status = objectBulkSetResponse.status
            successCount = objectBulkSetResponse.successCount
            updatedAt = objectBulkSetResponse.updatedAt
            completedAt = objectBulkSetResponse.completedAt
            errorCount = objectBulkSetResponse.errorCount
            errorItems = objectBulkSetResponse.errorItems.map { it.toMutableList() }
            failedAt = objectBulkSetResponse.failedAt
            startedAt = objectBulkSetResponse.startedAt
            additionalProperties = objectBulkSetResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): ObjectBulkSetResponse =
    ...
    override fun toString() =
        "ObjectBulkSetResponse{id=$id, _typename=$_typename, estimatedTotalRows=$estimatedTotalRows, insertedAt=$insertedAt, name=$name, processedRows=$processedRows, status=$status, successCount=$successCount, updatedAt=$updatedAt, completedAt=$completedAt, errorCount=$errorCount, errorItems=$errorItems, failedAt=$failedAt, startedAt=$startedAt, additionalProperties=$additionalProperties}"
}
