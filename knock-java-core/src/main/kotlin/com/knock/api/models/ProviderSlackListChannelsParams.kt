...
private constructor(
    ...
    /** A builder for [ProviderSlackListChannelsParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(providerSlackListChannelsParams: ProviderSlackListChannelsParams) =
            apply {
                channelId = providerSlackListChannelsParams.channelId
                accessTokenObject = providerSlackListChannelsParams.accessTokenObject
                queryOptions = providerSlackListChannelsParams.queryOptions
                additionalHeaders = providerSlackListChannelsParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    providerSlackListChannelsParams.additionalQueryParams.toBuilder()
            }
        ...
        fun build(): ProviderSlackListChannelsParams =
            ProviderSlackListChannelsParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ProviderSlackListChannelsParams && channelId == other.channelId && accessTokenObject == other.accessTokenObject && queryOptions == other.queryOptions && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "ProviderSlackListChannelsParams{channelId=$channelId, accessTokenObject=$accessTokenObject, queryOptions=$queryOptions, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
