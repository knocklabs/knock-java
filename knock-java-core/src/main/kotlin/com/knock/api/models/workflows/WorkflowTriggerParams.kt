 ...
 */
class WorkflowTriggerParams private constructor(
    ...
    class Body @JsonCreator private constructor(
         ...
         * cancellation of any workflow runs associated with this trigger.
         */
        fun cancellationKey(): Optional<String> = Optional.ofNullable(cancellationKey.getNullable("cancellation_key"))
         ...
         * single trigger.
         */
        fun recipients(): Optional<List<RecipientRequest>> = Optional.ofNullable(recipients.getNullable("recipients"))
        ...
        class Builder internal constructor() {
             ...
             * cancellation of any workflow runs associated with this trigger.
             */
            fun cancellationKey(cancellationKey: String?) = cancellationKey(JsonField.ofNullable(cancellationKey))

            /**
             * An optional key that is used in the workflow cancellation endpoint to target a
             * cancellation of any workflow runs associated with this trigger.
             */
            fun cancellationKey(cancellationKey: Optional<String>) = cancellationKey(cancellationKey.getOrNull())
        ...
        override fun toString() = "Body{actor=$actor, cancellationKey=$cancellationKey, data=$data, recipients=$recipients, tenant=$tenant, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(workflowTriggerParams: WorkflowTriggerParams) =
            apply {
    ...
    override fun toString() = "WorkflowTriggerParams{key=$key, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
