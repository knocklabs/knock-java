...
@NoAutoDetect
class ChannelBulkUpdateMessageStatusResponse
@JsonCreator
private constructor(
    ...
    fun validate(): ChannelBulkUpdateMessageStatusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [ChannelBulkUpdateMessageStatusResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            channelBulkUpdateMessageStatusResponse: ChannelBulkUpdateMessageStatusResponse
        ) = apply {
            id = channelBulkUpdateMessageStatusResponse.id
            _typename = channelBulkUpdateMessageStatusResponse._typename
            estimatedTotalRows = channelBulkUpdateMessageStatusResponse.estimatedTotalRows
            insertedAt = channelBulkUpdateMessageStatusResponse.insertedAt
            name = channelBulkUpdateMessageStatusResponse.name
            processedRows = channelBulkUpdateMessageStatusResponse.processedRows
            status = channelBulkUpdateMessageStatusResponse.status
            successCount = channelBulkUpdateMessageStatusResponse.successCount
            updatedAt = channelBulkUpdateMessageStatusResponse.updatedAt
            completedAt = channelBulkUpdateMessageStatusResponse.completedAt
            errorCount = channelBulkUpdateMessageStatusResponse.errorCount
            errorItems =
                channelBulkUpdateMessageStatusResponse.errorItems.map { it.toMutableList() }
            failedAt = channelBulkUpdateMessageStatusResponse.failedAt
            startedAt = channelBulkUpdateMessageStatusResponse.startedAt
            additionalProperties =
                channelBulkUpdateMessageStatusResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): ChannelBulkUpdateMessageStatusResponse =
            ChannelBulkUpdateMessageStatusResponse(
                checkRequired("id", id),
    ...
    override fun toString() =
        "ChannelBulkUpdateMessageStatusResponse{id=$id, _typename=$_typename, estimatedTotalRows=$estimatedTotalRows, insertedAt=$insertedAt, name=$name, processedRows=$processedRows, status=$status, successCount=$successCount, updatedAt=$updatedAt, completedAt=$completedAt, errorCount=$errorCount, errorItems=$errorItems, failedAt=$failedAt, startedAt=$startedAt, additionalProperties=$additionalProperties}"
}
