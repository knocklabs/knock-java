...
/** Remove members */
class AudienceRemoveMembersParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("members") @ExcludeMissing private val members: JsonField<List<Member>> = JsonMissing.of(),
        ...
        @ExcludeMissing
        fun _members(): JsonField<List<Member>> = members
        ...
        class Builder internal constructor() {
            ...
            fun members(members: JsonField<List<Member>>) =
                apply {
            ...
            fun addMember(member: Member) =
                apply {
                    members = (members ?: JsonField.of(mutableListOf())).also {
        ...
        override fun toString() = "Body{members=$members, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(audienceRemoveMembersParams: AudienceRemoveMembersParams) =
            apply {
        ...
        fun members(members: List<Member>) =
            apply {
    ...
    @NoAutoDetect
    class Member @JsonCreator private constructor(
        @JsonProperty("user") @ExcludeMissing private val user: JsonField<InlineIdentifyUserRequest> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(member: Member) =
                apply {
                    user = member.user
             ...
             * properties specified.
             */
            fun user(user: JsonField<InlineIdentifyUserRequest>) =
                apply {
                    this.user = user
                }
        ...
        override fun toString() = "Member{user=$user, tenant=$tenant, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "AudienceRemoveMembersParams{key=$key, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
