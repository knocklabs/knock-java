...
private constructor(
    ...
    fun validate(): UserBulkDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserBulkDeleteResponse].
         *
    ...
    /** A builder for [UserBulkDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userBulkDeleteResponse: UserBulkDeleteResponse) = apply {
            id = userBulkDeleteResponse.id
            _typename = userBulkDeleteResponse._typename
            estimatedTotalRows = userBulkDeleteResponse.estimatedTotalRows
            insertedAt = userBulkDeleteResponse.insertedAt
            name = userBulkDeleteResponse.name
            processedRows = userBulkDeleteResponse.processedRows
            status = userBulkDeleteResponse.status
            successCount = userBulkDeleteResponse.successCount
            updatedAt = userBulkDeleteResponse.updatedAt
            completedAt = userBulkDeleteResponse.completedAt
            errorCount = userBulkDeleteResponse.errorCount
            errorItems = userBulkDeleteResponse.errorItems.map { it.toMutableList() }
            failedAt = userBulkDeleteResponse.failedAt
            startedAt = userBulkDeleteResponse.startedAt
            additionalProperties = userBulkDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): UserBulkDeleteResponse =
