...
@NoAutoDetect
class UserFeedGetSettingsResponse
@JsonCreator
private constructor(
    ...
    fun validate(): UserFeedGetSettingsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserFeedGetSettingsResponse].
         *
    ...
    /** A builder for [UserFeedGetSettingsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userFeedGetSettingsResponse: UserFeedGetSettingsResponse) = apply {
            features = userFeedGetSettingsResponse.features
            additionalProperties = userFeedGetSettingsResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): UserFeedGetSettingsResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is UserFeedGetSettingsResponse && features == other.features && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "UserFeedGetSettingsResponse{features=$features, additionalProperties=$additionalProperties}"
}
