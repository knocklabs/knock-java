...
@NoAutoDetect
class ProviderMsTeamListChannelsResponse
@JsonCreator
private constructor(
    ...
    fun validate(): ProviderMsTeamListChannelsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [ProviderMsTeamListChannelsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(providerMsTeamListChannelsResponse: ProviderMsTeamListChannelsResponse) =
            apply {
                msTeamsChannels =
                    providerMsTeamListChannelsResponse.msTeamsChannels.map { it.toMutableList() }
                additionalProperties =
                    providerMsTeamListChannelsResponse.additionalProperties.toMutableMap()
            }
        ...
        fun build(): ProviderMsTeamListChannelsResponse =
            ProviderMsTeamListChannelsResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ProviderMsTeamListChannelsResponse && msTeamsChannels == other.msTeamsChannels && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ProviderMsTeamListChannelsResponse{msTeamsChannels=$msTeamsChannels, additionalProperties=$additionalProperties}"
}
