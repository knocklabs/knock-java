...
private constructor(
    ...
    fun validate(): MessageGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [MessageGetResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MessageGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageGetResponse: MessageGetResponse) = apply {
            id = messageGetResponse.id
            _typename = messageGetResponse._typename
            actors = messageGetResponse.actors.map { it.toMutableList() }
            archivedAt = messageGetResponse.archivedAt
            channelId = messageGetResponse.channelId
            clickedAt = messageGetResponse.clickedAt
            data = messageGetResponse.data
            engagementStatuses = messageGetResponse.engagementStatuses.map { it.toMutableList() }
            insertedAt = messageGetResponse.insertedAt
            interactedAt = messageGetResponse.interactedAt
            linkClickedAt = messageGetResponse.linkClickedAt
            metadata = messageGetResponse.metadata
            readAt = messageGetResponse.readAt
            recipient = messageGetResponse.recipient
            scheduledAt = messageGetResponse.scheduledAt
            seenAt = messageGetResponse.seenAt
            source = messageGetResponse.source
            status = messageGetResponse.status
            tenant = messageGetResponse.tenant
            updatedAt = messageGetResponse.updatedAt
            workflow = messageGetResponse.workflow
            additionalProperties = messageGetResponse.additionalProperties.toMutableMap()
        }
