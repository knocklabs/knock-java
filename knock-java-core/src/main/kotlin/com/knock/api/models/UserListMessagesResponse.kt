...
@NoAutoDetect
class UserListMessagesResponse
@JsonCreator
private constructor(
    ...
    fun validate(): UserListMessagesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [UserListMessagesResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [UserListMessagesResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userListMessagesResponse: UserListMessagesResponse) = apply {
            id = userListMessagesResponse.id
            _typename = userListMessagesResponse._typename
            actors = userListMessagesResponse.actors.map { it.toMutableList() }
            archivedAt = userListMessagesResponse.archivedAt
            channelId = userListMessagesResponse.channelId
            clickedAt = userListMessagesResponse.clickedAt
            data = userListMessagesResponse.data
            engagementStatuses =
                userListMessagesResponse.engagementStatuses.map { it.toMutableList() }
            insertedAt = userListMessagesResponse.insertedAt
            interactedAt = userListMessagesResponse.interactedAt
            linkClickedAt = userListMessagesResponse.linkClickedAt
            metadata = userListMessagesResponse.metadata
            readAt = userListMessagesResponse.readAt
            recipient = userListMessagesResponse.recipient
            scheduledAt = userListMessagesResponse.scheduledAt
            seenAt = userListMessagesResponse.seenAt
            source = userListMessagesResponse.source
            status = userListMessagesResponse.status
            tenant = userListMessagesResponse.tenant
            updatedAt = userListMessagesResponse.updatedAt
            workflow = userListMessagesResponse.workflow
            additionalProperties = userListMessagesResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): UserListMessagesResponse =
