...
private constructor(
    ...
    class AutoPager(private val firstPage: MessageListPage) : Iterable<MessageListResponse> {

        override fun iterator(): Iterator<MessageListResponse> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
        ...
        fun stream(): Stream<MessageListResponse> {
