...
/** List schedules */
class UserListSchedulesPage private constructor(
    ...
    override fun toString() = "UserListSchedulesPage{usersService=$usersService, params=$params, response=$response}"
    ...
    class AutoPager(
        private val firstPage: UserListSchedulesPage,
