 ...
 * feed.
 */
class FeedListItemsPage private constructor(
    ...
    override fun toString() = "FeedListItemsPage{feedsService=$feedsService, params=$params, response=$response}"
    ...
    class AutoPager(
        private val firstPage: FeedListItemsPage,

    ) : Iterable<FeedListItemsResponse> {

        override fun iterator(): Iterator<FeedListItemsResponse> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
