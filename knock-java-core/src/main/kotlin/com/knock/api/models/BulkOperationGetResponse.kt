...
@NoAutoDetect
class BulkOperationGetResponse
@JsonCreator
private constructor(
    ...
    fun validate(): BulkOperationGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BulkOperationGetResponse].
         *
    ...
    /** A builder for [BulkOperationGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bulkOperationGetResponse: BulkOperationGetResponse) = apply {
            id = bulkOperationGetResponse.id
            _typename = bulkOperationGetResponse._typename
            estimatedTotalRows = bulkOperationGetResponse.estimatedTotalRows
            insertedAt = bulkOperationGetResponse.insertedAt
            name = bulkOperationGetResponse.name
            processedRows = bulkOperationGetResponse.processedRows
            status = bulkOperationGetResponse.status
            successCount = bulkOperationGetResponse.successCount
            updatedAt = bulkOperationGetResponse.updatedAt
            completedAt = bulkOperationGetResponse.completedAt
            errorCount = bulkOperationGetResponse.errorCount
            errorItems = bulkOperationGetResponse.errorItems.map { it.toMutableList() }
            failedAt = bulkOperationGetResponse.failedAt
            startedAt = bulkOperationGetResponse.startedAt
            additionalProperties = bulkOperationGetResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): BulkOperationGetResponse =
    ...
    override fun toString() =
        "BulkOperationGetResponse{id=$id, _typename=$_typename, estimatedTotalRows=$estimatedTotalRows, insertedAt=$insertedAt, name=$name, processedRows=$processedRows, status=$status, successCount=$successCount, updatedAt=$updatedAt, completedAt=$completedAt, errorCount=$errorCount, errorItems=$errorItems, failedAt=$failedAt, startedAt=$startedAt, additionalProperties=$additionalProperties}"
}
