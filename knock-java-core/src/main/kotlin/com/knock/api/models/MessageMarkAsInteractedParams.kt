...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageMarkAsInteractedParams: MessageMarkAsInteractedParams) = apply {
    ...
    override fun toString() =
        "MessageMarkAsInteractedParams{messageId=$messageId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
