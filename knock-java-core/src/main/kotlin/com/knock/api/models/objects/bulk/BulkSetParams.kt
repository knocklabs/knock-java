...
class BulkSetParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("objects") @ExcludeMissing private val objects: JsonField<List<InlineObjectRequest>> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            fun objects(objects: JsonField<List<InlineObjectRequest>>) =
                apply {
                    this.objects = objects.map { it.toMutableList() }
                }

            fun addObject(object_: InlineObjectRequest) =
                apply {
                    objects = (objects ?: JsonField.of(mutableListOf())).also {
        ...
        override fun toString() = "Body{objects=$objects, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        fun objects(objects: List<InlineObjectRequest>) =
            apply {
    ...
    override fun toString() = "BulkSetParams{collection=$collection, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
