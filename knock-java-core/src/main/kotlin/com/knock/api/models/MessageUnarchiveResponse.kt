...
@NoAutoDetect
class MessageUnarchiveResponse
@JsonCreator
private constructor(
    ...
    fun validate(): MessageUnarchiveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [MessageUnarchiveResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MessageUnarchiveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageUnarchiveResponse: MessageUnarchiveResponse) = apply {
            id = messageUnarchiveResponse.id
            _typename = messageUnarchiveResponse._typename
            actors = messageUnarchiveResponse.actors.map { it.toMutableList() }
            archivedAt = messageUnarchiveResponse.archivedAt
            channelId = messageUnarchiveResponse.channelId
            clickedAt = messageUnarchiveResponse.clickedAt
            data = messageUnarchiveResponse.data
            engagementStatuses =
                messageUnarchiveResponse.engagementStatuses.map { it.toMutableList() }
            insertedAt = messageUnarchiveResponse.insertedAt
            interactedAt = messageUnarchiveResponse.interactedAt
            linkClickedAt = messageUnarchiveResponse.linkClickedAt
            metadata = messageUnarchiveResponse.metadata
            readAt = messageUnarchiveResponse.readAt
            recipient = messageUnarchiveResponse.recipient
            scheduledAt = messageUnarchiveResponse.scheduledAt
            seenAt = messageUnarchiveResponse.seenAt
            source = messageUnarchiveResponse.source
            status = messageUnarchiveResponse.status
            tenant = messageUnarchiveResponse.tenant
            updatedAt = messageUnarchiveResponse.updatedAt
            workflow = messageUnarchiveResponse.workflow
            additionalProperties = messageUnarchiveResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): MessageUnarchiveResponse =
