...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ObjectBulkSetParams].
         *
         * The following fields are required:
         * ```java
         * .collection()
    ...
    /** A builder for [ObjectBulkSetParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(objectBulkSetParams: ObjectBulkSetParams) = apply {
            collection = objectBulkSetParams.collection
            body = objectBulkSetParams.body.toBuilder()
            additionalHeaders = objectBulkSetParams.additionalHeaders.toBuilder()
            additionalQueryParams = objectBulkSetParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ObjectBulkSetParams && collection == other.collection && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(collection, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ObjectBulkSetParams{collection=$collection, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
