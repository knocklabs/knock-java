...
private constructor(
    ...
    fun validate(): TenantBulkSetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TenantBulkSetResponse].
         *
    ...
    /** A builder for [TenantBulkSetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tenantBulkSetResponse: TenantBulkSetResponse) = apply {
            id = tenantBulkSetResponse.id
            _typename = tenantBulkSetResponse._typename
            estimatedTotalRows = tenantBulkSetResponse.estimatedTotalRows
            insertedAt = tenantBulkSetResponse.insertedAt
            name = tenantBulkSetResponse.name
            processedRows = tenantBulkSetResponse.processedRows
            status = tenantBulkSetResponse.status
            successCount = tenantBulkSetResponse.successCount
            updatedAt = tenantBulkSetResponse.updatedAt
            completedAt = tenantBulkSetResponse.completedAt
            errorCount = tenantBulkSetResponse.errorCount
            errorItems = tenantBulkSetResponse.errorItems.map { it.toMutableList() }
            failedAt = tenantBulkSetResponse.failedAt
            startedAt = tenantBulkSetResponse.startedAt
            additionalProperties = tenantBulkSetResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): TenantBulkSetResponse =
