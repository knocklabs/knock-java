...
/** Create schedules */
class ScheduleCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("recipients") @ExcludeMissing private val recipients: JsonField<List<Recipient>> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            fun recipients(recipients: JsonField<List<Recipient>>) =
                apply {
            ...
            fun addRecipient(objectReference: Recipient.ObjectReference) = addRecipient(Recipient.ofObjectReference(objectReference))
        ...
        override fun toString() = "Body{recipients=$recipients, repeats=$repeats, workflow=$workflow, data=$data, endingAt=$endingAt, scheduledAt=$scheduledAt, tenant=$tenant, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scheduleCreateParams: ScheduleCreateParams) =
            apply {
    ...
    override fun toString() = "ScheduleCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
