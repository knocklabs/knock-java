...
@NoAutoDetect
class InlineObjectRequest @JsonCreator private constructor(
    ...
    fun validate(): InlineObjectRequest =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(inlineObjectRequest: InlineObjectRequest) =
            apply {
    ...
    override fun toString() = "InlineObjectRequest{id=$id, collection=$collection, channelData=$channelData, createdAt=$createdAt, preferences=$preferences, additionalProperties=$additionalProperties}"
}
