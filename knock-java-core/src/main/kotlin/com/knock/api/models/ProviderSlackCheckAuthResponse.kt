...
@NoAutoDetect
class ProviderSlackCheckAuthResponse
@JsonCreator
private constructor(
    ...
    fun validate(): ProviderSlackCheckAuthResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [ProviderSlackCheckAuthResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(providerSlackCheckAuthResponse: ProviderSlackCheckAuthResponse) = apply {
            connection = providerSlackCheckAuthResponse.connection
            additionalProperties =
                providerSlackCheckAuthResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): ProviderSlackCheckAuthResponse =
            ProviderSlackCheckAuthResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ProviderSlackCheckAuthResponse && connection == other.connection && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ProviderSlackCheckAuthResponse{connection=$connection, additionalProperties=$additionalProperties}"
}
