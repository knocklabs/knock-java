...
private constructor(
    ...
    fun validate(): MessageMarkAsReadResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageMarkAsReadResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MessageMarkAsReadResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageMarkAsReadResponse: MessageMarkAsReadResponse) = apply {
            id = messageMarkAsReadResponse.id
            _typename = messageMarkAsReadResponse._typename
            actors = messageMarkAsReadResponse.actors.map { it.toMutableList() }
            archivedAt = messageMarkAsReadResponse.archivedAt
            channelId = messageMarkAsReadResponse.channelId
            clickedAt = messageMarkAsReadResponse.clickedAt
            data = messageMarkAsReadResponse.data
            engagementStatuses =
                messageMarkAsReadResponse.engagementStatuses.map { it.toMutableList() }
            insertedAt = messageMarkAsReadResponse.insertedAt
            interactedAt = messageMarkAsReadResponse.interactedAt
            linkClickedAt = messageMarkAsReadResponse.linkClickedAt
            metadata = messageMarkAsReadResponse.metadata
            readAt = messageMarkAsReadResponse.readAt
            recipient = messageMarkAsReadResponse.recipient
            scheduledAt = messageMarkAsReadResponse.scheduledAt
            seenAt = messageMarkAsReadResponse.seenAt
            source = messageMarkAsReadResponse.source
            status = messageMarkAsReadResponse.status
            tenant = messageMarkAsReadResponse.tenant
            updatedAt = messageMarkAsReadResponse.updatedAt
            workflow = messageMarkAsReadResponse.workflow
            additionalProperties = messageMarkAsReadResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): MessageMarkAsReadResponse =
