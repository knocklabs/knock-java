...
class RecipientRequest private constructor(
     ...
     */
    fun inlineIdentifyUser(): Optional<InlineIdentifyUserRequest> = Optional.ofNullable(inlineIdentifyUser)
     ...
     * properties specified.
     */
    fun asInlineIdentifyUser(): InlineIdentifyUserRequest = inlineIdentifyUser.getOrThrow("inlineIdentifyUser")
    ...
    fun validate(): RecipientRequest =
        apply {
            ...
            accept(object : Visitor<Unit> {
                ...
                override fun visitInlineIdentifyUser(inlineIdentifyUser: InlineIdentifyUserRequest) {
    ...
    companion object {
        ...
        /** A user identifier */
        @JvmStatic
        fun ofString(string: String) = RecipientRequest(string = string)
         ...
         */
        @JvmStatic
        fun ofInlineIdentifyUser(inlineIdentifyUser: InlineIdentifyUserRequest) = RecipientRequest(inlineIdentifyUser = inlineIdentifyUser)

        /** Inline identifies a custom object belonging to a collection */
        @JvmStatic
        fun ofInlineObject(inlineObject: InlineObjectRequest) = RecipientRequest(inlineObject = inlineObject)
    }

    /**
     * An interface that defines how to map each variant of [RecipientRequest] to a
     * value of type [T].
     */
    interface Visitor<out T> {
         ...
         *
         * An instance of [RecipientRequest] can contain an unknown variant if it was
    ...
    internal class Deserializer : BaseDeserializer<RecipientRequest>(RecipientRequest::class) {
        ...
        override fun ObjectCodec.deserialize(node: JsonNode): RecipientRequest {
          ...
          tryDeserialize(node, jacksonTypeRef<InlineIdentifyUserRequest>()){ it.validate() }?.let {
              return RecipientRequest(inlineIdentifyUser = it, _json = json)
          }
          tryDeserialize(node, jacksonTypeRef<InlineObjectRequest>()){ it.validate() }?.let {
    ...
    internal class Serializer : BaseSerializer<RecipientRequest>(RecipientRequest::class) {
        ...
        override fun serialize(value: RecipientRequest, generator: JsonGenerator, provider: SerializerProvider) {
          when {
