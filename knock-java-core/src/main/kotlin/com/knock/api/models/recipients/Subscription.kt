...
class Subscription @JsonCreator private constructor(
    ...
    @JsonProperty("object") @ExcludeMissing private val object_: JsonField<Object> = JsonMissing.of(),
    ...
    override fun toString() = "Subscription{_typename=$_typename, insertedAt=$insertedAt, object_=$object_, recipient=$recipient, updatedAt=$updatedAt, properties=$properties, additionalProperties=$additionalProperties}"
}
