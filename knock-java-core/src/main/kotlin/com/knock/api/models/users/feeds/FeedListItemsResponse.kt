...
import com.knock.api.models.messages.Activity
...
@NoAutoDetect
class FeedListItemsResponse @JsonCreator private constructor(
    @JsonProperty("id") @ExcludeMissing private val id: JsonField<String> = JsonMissing.of(),
    @JsonProperty("__typename") @ExcludeMissing private val _typename: JsonField<String> = JsonMissing.of(),
    @JsonProperty("activities") @ExcludeMissing private val activities: JsonField<List<Activity>> = JsonMissing.of(),
    @JsonProperty("actors") @ExcludeMissing private val actors: JsonField<List<Recipient>> = JsonMissing.of(),
    ...
    @JsonProperty("total_activities") @ExcludeMissing private val totalActivities: JsonField<Long> = JsonMissing.of(),
    @JsonProperty("total_actors") @ExcludeMissing private val totalActors: JsonField<Long> = JsonMissing.of(),
    @JsonProperty("updated_at") @ExcludeMissing private val updatedAt: JsonField<String> = JsonMissing.of(),
    @JsonProperty("archived_at") @ExcludeMissing private val archivedAt: JsonField<String> = JsonMissing.of(),
    @JsonProperty("clicked_at") @ExcludeMissing private val clickedAt: JsonField<String> = JsonMissing.of(),
    @JsonProperty("interacted_at") @ExcludeMissing private val interactedAt: JsonField<String> = JsonMissing.of(),
    @JsonProperty("link_clicked_at") @ExcludeMissing private val linkClickedAt: JsonField<String> = JsonMissing.of(),
    @JsonProperty("read_at") @ExcludeMissing private val readAt: JsonField<String> = JsonMissing.of(),
    @JsonProperty("seen_at") @ExcludeMissing private val seenAt: JsonField<String> = JsonMissing.of(),
    ...
    fun interactedAt(): Optional<String> = Optional.ofNullable(interactedAt.getNullable("interacted_at"))

    fun linkClickedAt(): Optional<String> = Optional.ofNullable(linkClickedAt.getNullable("link_clicked_at"))
    ...
    @JsonProperty("actors")
    @ExcludeMissing
    fun _actors(): JsonField<List<Recipient>> = actors
    ...
    @ExcludeMissing
    fun _totalActors(): JsonField<Long> = totalActors
    ...
    @ExcludeMissing
    fun _archivedAt(): JsonField<String> = archivedAt

    @JsonProperty("clicked_at")
    @ExcludeMissing
    fun _clickedAt(): JsonField<String> = clickedAt
    ...
    @ExcludeMissing
    fun _readAt(): JsonField<String> = readAt

    @JsonProperty("seen_at")
    @ExcludeMissing
    fun _seenAt(): JsonField<String> = seenAt
    ...
    fun validate(): FeedListItemsResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(feedListItemsResponse: FeedListItemsResponse) =
            apply {
        ...
        fun activities(activities: JsonField<List<Activity>>) =
            apply {
        ...
        fun addActivity(activity: Activity) =
            apply {
                activities = (activities ?: JsonField.of(mutableListOf())).also {
        ...
        fun actors(actors: JsonField<List<Recipient>>) =
            apply {
                this.actors = actors.map { it.toMutableList() }
            }

        fun addActor(actor: Recipient) =
            apply {
        ...
        fun totalActivities(totalActivities: JsonField<Long>) =
            apply {
        ...
        fun totalActors(totalActors: JsonField<Long>) =
            apply {
        ...
        fun archivedAt(archivedAt: JsonField<String>) =
            apply {
        ...
        fun clickedAt(clickedAt: JsonField<String>) =
            apply {
        ...
        fun interactedAt(interactedAt: JsonField<String>) =
            apply {
                this.interactedAt = interactedAt
            }

        fun linkClickedAt(linkClickedAt: String?) = linkClickedAt(JsonField.ofNullable(linkClickedAt))

        fun linkClickedAt(linkClickedAt: Optional<String>) = linkClickedAt(linkClickedAt.getOrNull())

        fun linkClickedAt(linkClickedAt: JsonField<String>) =
            apply {
        ...
        fun readAt(readAt: JsonField<String>) =
            apply {
                this.readAt = readAt
            }
        ...
        fun seenAt(seenAt: JsonField<String>) =
            apply {
                this.seenAt = seenAt
            }
    ...
    class Source @JsonCreator private constructor(
        @JsonProperty("__typename") @ExcludeMissing private val _typename: JsonField<String> = JsonMissing.of(),
        @JsonProperty("categories") @ExcludeMissing private val categories: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("key") @ExcludeMissing private val key: JsonField<String> = JsonMissing.of(),
        @JsonProperty("version_id") @ExcludeMissing private val versionId: JsonField<String> = JsonMissing.of(),
        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(source: Source) =
                apply {
            ...
            fun categories(categories: JsonField<List<String>>) =
                apply {
            ...
            fun addCategory(category: String) =
                apply {
                    categories = (categories ?: JsonField.of(mutableListOf())).also {
            ...
            fun versionId(versionId: JsonField<String>) =
                apply {
        ...
        override fun toString() = "Source{_typename=$_typename, categories=$categories, key=$key, versionId=$versionId, additionalProperties=$additionalProperties}"
    }
