...
@NoAutoDetect
class ObjectBulkAddSubscriptionsResponse
@JsonCreator
private constructor(
    ...
    fun validate(): ObjectBulkAddSubscriptionsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [ObjectBulkAddSubscriptionsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(objectBulkAddSubscriptionsResponse: ObjectBulkAddSubscriptionsResponse) =
            apply {
                id = objectBulkAddSubscriptionsResponse.id
                _typename = objectBulkAddSubscriptionsResponse._typename
                estimatedTotalRows = objectBulkAddSubscriptionsResponse.estimatedTotalRows
                insertedAt = objectBulkAddSubscriptionsResponse.insertedAt
                name = objectBulkAddSubscriptionsResponse.name
                processedRows = objectBulkAddSubscriptionsResponse.processedRows
                status = objectBulkAddSubscriptionsResponse.status
                successCount = objectBulkAddSubscriptionsResponse.successCount
                updatedAt = objectBulkAddSubscriptionsResponse.updatedAt
                completedAt = objectBulkAddSubscriptionsResponse.completedAt
                errorCount = objectBulkAddSubscriptionsResponse.errorCount
                errorItems =
                    objectBulkAddSubscriptionsResponse.errorItems.map { it.toMutableList() }
                failedAt = objectBulkAddSubscriptionsResponse.failedAt
                startedAt = objectBulkAddSubscriptionsResponse.startedAt
                additionalProperties =
                    objectBulkAddSubscriptionsResponse.additionalProperties.toMutableMap()
            }
        ...
        fun build(): ObjectBulkAddSubscriptionsResponse =
            ObjectBulkAddSubscriptionsResponse(
                checkRequired("id", id),
    ...
    override fun toString() =
        "ObjectBulkAddSubscriptionsResponse{id=$id, _typename=$_typename, estimatedTotalRows=$estimatedTotalRows, insertedAt=$insertedAt, name=$name, processedRows=$processedRows, status=$status, successCount=$successCount, updatedAt=$updatedAt, completedAt=$completedAt, errorCount=$errorCount, errorItems=$errorItems, failedAt=$failedAt, startedAt=$startedAt, additionalProperties=$additionalProperties}"
}
