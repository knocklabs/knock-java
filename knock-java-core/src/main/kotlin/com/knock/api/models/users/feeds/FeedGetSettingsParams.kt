...
class FeedGetSettingsParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(feedGetSettingsParams: FeedGetSettingsParams) =
            apply {
                userId = feedGetSettingsParams.userId
                channelId = feedGetSettingsParams.channelId
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return /* spotless:off */ other is FeedGetSettingsParams && userId == other.userId && channelId == other.channelId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(userId, channelId, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() = "FeedGetSettingsParams{userId=$userId, channelId=$channelId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
