...
@NoAutoDetect
class MessageMarkAsUnseenResponse
@JsonCreator
private constructor(
    ...
    fun validate(): MessageMarkAsUnseenResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageMarkAsUnseenResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MessageMarkAsUnseenResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageMarkAsUnseenResponse: MessageMarkAsUnseenResponse) = apply {
            id = messageMarkAsUnseenResponse.id
            _typename = messageMarkAsUnseenResponse._typename
            actors = messageMarkAsUnseenResponse.actors.map { it.toMutableList() }
            archivedAt = messageMarkAsUnseenResponse.archivedAt
            channelId = messageMarkAsUnseenResponse.channelId
            clickedAt = messageMarkAsUnseenResponse.clickedAt
            data = messageMarkAsUnseenResponse.data
            engagementStatuses =
                messageMarkAsUnseenResponse.engagementStatuses.map { it.toMutableList() }
            insertedAt = messageMarkAsUnseenResponse.insertedAt
            interactedAt = messageMarkAsUnseenResponse.interactedAt
            linkClickedAt = messageMarkAsUnseenResponse.linkClickedAt
            metadata = messageMarkAsUnseenResponse.metadata
            readAt = messageMarkAsUnseenResponse.readAt
            recipient = messageMarkAsUnseenResponse.recipient
            scheduledAt = messageMarkAsUnseenResponse.scheduledAt
            seenAt = messageMarkAsUnseenResponse.seenAt
            source = messageMarkAsUnseenResponse.source
            status = messageMarkAsUnseenResponse.status
            tenant = messageMarkAsUnseenResponse.tenant
            updatedAt = messageMarkAsUnseenResponse.updatedAt
            workflow = messageMarkAsUnseenResponse.workflow
            additionalProperties = messageMarkAsUnseenResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): MessageMarkAsUnseenResponse =
