...
@NoAutoDetect
class ObjectListMessagesResponse
@JsonCreator
private constructor(
    ...
    fun validate(): ObjectListMessagesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ObjectListMessagesResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ObjectListMessagesResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(objectListMessagesResponse: ObjectListMessagesResponse) = apply {
            id = objectListMessagesResponse.id
            _typename = objectListMessagesResponse._typename
            actors = objectListMessagesResponse.actors.map { it.toMutableList() }
            archivedAt = objectListMessagesResponse.archivedAt
            channelId = objectListMessagesResponse.channelId
            clickedAt = objectListMessagesResponse.clickedAt
            data = objectListMessagesResponse.data
            engagementStatuses =
                objectListMessagesResponse.engagementStatuses.map { it.toMutableList() }
            insertedAt = objectListMessagesResponse.insertedAt
            interactedAt = objectListMessagesResponse.interactedAt
            linkClickedAt = objectListMessagesResponse.linkClickedAt
            metadata = objectListMessagesResponse.metadata
            readAt = objectListMessagesResponse.readAt
            recipient = objectListMessagesResponse.recipient
            scheduledAt = objectListMessagesResponse.scheduledAt
            seenAt = objectListMessagesResponse.seenAt
            source = objectListMessagesResponse.source
            status = objectListMessagesResponse.status
            tenant = objectListMessagesResponse.tenant
            updatedAt = objectListMessagesResponse.updatedAt
            workflow = objectListMessagesResponse.workflow
            additionalProperties = objectListMessagesResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): ObjectListMessagesResponse =
