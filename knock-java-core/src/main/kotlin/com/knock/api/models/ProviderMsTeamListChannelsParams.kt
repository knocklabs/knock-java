 ...
 */
class ProviderMsTeamListChannelsParams
private constructor(
    ...
    override fun _queryParams(): QueryParams {
        ...
        this.teamId.let { queryParams.put("team_id", listOf(it.toString())) }
    ...
    companion object {
         ...
         * [ProviderMsTeamListChannelsParams].
         *
    ...
    /** A builder for [ProviderMsTeamListChannelsParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(providerMsTeamListChannelsParams: ProviderMsTeamListChannelsParams) =
            apply {
                channelId = providerMsTeamListChannelsParams.channelId
                msTeamsTenantObject = providerMsTeamListChannelsParams.msTeamsTenantObject
                teamId = providerMsTeamListChannelsParams.teamId
                queryOptions = providerMsTeamListChannelsParams.queryOptions
                additionalHeaders = providerMsTeamListChannelsParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    providerMsTeamListChannelsParams.additionalQueryParams.toBuilder()
            }
        ...
        fun build(): ProviderMsTeamListChannelsParams =
            ProviderMsTeamListChannelsParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ProviderMsTeamListChannelsParams && channelId == other.channelId && msTeamsTenantObject == other.msTeamsTenantObject && teamId == other.teamId && queryOptions == other.queryOptions && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "ProviderMsTeamListChannelsParams{channelId=$channelId, msTeamsTenantObject=$msTeamsTenantObject, teamId=$teamId, queryOptions=$queryOptions, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
