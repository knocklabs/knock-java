...
package com.knock.api.core

import com.fasterxml.jackson.databind.json.JsonMapper
import com.knock.api.core.http.Headers
import com.knock.api.core.http.HttpClient
import com.knock.api.core.http.PhantomReachableClosingHttpClient
import com.knock.api.core.http.QueryParams
import com.knock.api.core.http.RetryingHttpClient
...
class ClientOptions private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun fromEnv() =
            apply {
                System.getenv("KNOCK_API_KEY")?.let {
                    bearerToken(it)
                }
            }
