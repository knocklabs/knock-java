package com.knock.api.core.http

import com.knock.api.core.RequestOptions
import com.knock.api.core.checkRequired
import com.knock.api.errors.KnockIoException
...
private constructor(
    ...
    private fun shouldRetry(throwable: Throwable): Boolean =
        // Only retry IOException and KnockIoException, other exceptions are not intended to be
        // retried.
        throwable is IOException || throwable is KnockIoException
