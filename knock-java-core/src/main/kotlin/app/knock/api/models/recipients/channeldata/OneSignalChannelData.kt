...
private constructor(
    ...
    ) : this(playerIds, type, _typename, mutableMapOf())
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OneSignalChannelData && playerIds == other.playerIds && type == other.type && _typename == other._typename && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(playerIds, type, _typename, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "OneSignalChannelData{playerIds=$playerIds, type=$type, _typename=$_typename, additionalProperties=$additionalProperties}"
}
