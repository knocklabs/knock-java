...
class ObjectListPage private constructor(
    ...
    override fun toString() = "ObjectListPage{objectsService=$objectsService, params=$params, response=$response}"
    ...
    class AutoPager(
        private val firstPage: ObjectListPage,
