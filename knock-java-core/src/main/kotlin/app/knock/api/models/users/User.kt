...
class User @JsonCreator private constructor(
    ...
    @JsonProperty("avatar") @ExcludeMissing private val avatar: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("phone_number") @ExcludeMissing private val phoneNumber: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("avatar")
    @ExcludeMissing
    fun _avatar(): JsonField<String> = avatar
    ...
    class Builder internal constructor() {
        ...
        fun avatar(avatar: JsonField<String>) =
            apply {
                this.avatar = avatar
            }
    ...
    override fun toString() = "User{id=$id, _typename=$_typename, updatedAt=$updatedAt, avatar=$avatar, createdAt=$createdAt, email=$email, name=$name, phoneNumber=$phoneNumber, timezone=$timezone, additionalProperties=$additionalProperties}"
}
