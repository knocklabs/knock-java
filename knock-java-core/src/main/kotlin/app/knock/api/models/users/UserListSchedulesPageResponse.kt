...
class UserListSchedulesPageResponse
private constructor(
    ...
    /** A builder for [UserListSchedulesPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userListSchedulesPageResponse: UserListSchedulesPageResponse) = apply {
            entries = userListSchedulesPageResponse.entries.map { it.toMutableList() }
            pageInfo = userListSchedulesPageResponse.pageInfo
            additionalProperties = userListSchedulesPageResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): UserListSchedulesPageResponse =
            UserListSchedulesPageResponse(
    ...
    fun validate(): UserListSchedulesPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is UserListSchedulesPageResponse && entries == other.entries && pageInfo == other.pageInfo && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "UserListSchedulesPageResponse{entries=$entries, pageInfo=$pageInfo, additionalProperties=$additionalProperties}"
}
