...
private constructor(
    ...
    private val preferences: JsonField<List<InlinePreferenceSetRequest>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        preferences: JsonField<List<InlinePreferenceSetRequest>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun preferences(): Optional<List<InlinePreferenceSetRequest>> =
    ...
    @JsonProperty("preferences")
    @ExcludeMissing
    fun _preferences(): JsonField<List<InlinePreferenceSetRequest>> = preferences
    ...
    class Builder internal constructor() {
        ...
        private var preferences: JsonField<MutableList<InlinePreferenceSetRequest>>? = null
        ...
        /** An optional set of [preferences](/concepts/preferences) for the object. */
        fun preferences(preferences: List<InlinePreferenceSetRequest>?) =
            preferences(JsonField.ofNullable(preferences))

        /** Alias for calling [Builder.preferences] with `preferences.orElse(null)`. */
        fun preferences(preferences: Optional<List<InlinePreferenceSetRequest>>) =
         ...
         * `List<InlinePreferenceSetRequest>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun preferences(preferences: JsonField<List<InlinePreferenceSetRequest>>) = apply {
            this.preferences = preferences.map { it.toMutableList() }
        }

        /**
         * Adds a single [InlinePreferenceSetRequest] to [preferences].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addPreference(preference: InlinePreferenceSetRequest) = apply {
            preferences =
