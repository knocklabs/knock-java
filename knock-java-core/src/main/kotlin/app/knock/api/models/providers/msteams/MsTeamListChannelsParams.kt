 ...
 */
class MsTeamListChannelsParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(msTeamListChannelsParams: MsTeamListChannelsParams) =
            apply {
    ...
    class QueryOptions private constructor(
        ...
        override fun toString() = "QueryOptions{filter=$filter, select=$select, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "MsTeamListChannelsParams{channelId=$channelId, msTeamsTenantObject=$msTeamsTenantObject, teamId=$teamId, queryOptions=$queryOptions, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
