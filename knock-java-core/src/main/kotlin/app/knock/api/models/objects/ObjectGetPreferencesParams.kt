...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ObjectGetPreferencesParams = builder().build()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ObjectGetPreferencesParams && collection == other.collection && objectId == other.objectId && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(collection, objectId, id, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ObjectGetPreferencesParams{collection=$collection, objectId=$objectId, id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
