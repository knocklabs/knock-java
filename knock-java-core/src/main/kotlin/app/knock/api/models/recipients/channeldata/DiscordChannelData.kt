...
private constructor(
    ...
    ) : this(_typename, connections, mutableMapOf())
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DiscordChannelData && _typename == other._typename && connections == other.connections && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(_typename, connections, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "DiscordChannelData{_typename=$_typename, connections=$connections, additionalProperties=$additionalProperties}"
}
