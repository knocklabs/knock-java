...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        entries: JsonField<List<Tenant>> = JsonMissing.of(),
     ...
     */
    fun entries(): List<Tenant> = entries.getRequired("entries")
     ...
     */
    @JsonProperty("entries") @ExcludeMissing fun _entries(): JsonField<List<Tenant>> = entries
    ...
    class Builder internal constructor() {
        ...
        private var entries: JsonField<MutableList<Tenant>>? = null
        private var pageInfo: JsonField<PageInfo>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(tenantListPageResponse: TenantListPageResponse) = apply {
            entries = tenantListPageResponse.entries.map { it.toMutableList() }
            pageInfo = tenantListPageResponse.pageInfo
            additionalProperties = tenantListPageResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.entries] with a well-typed `List<Tenant>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun entries(entries: JsonField<List<Tenant>>) = apply {
         ...
         */
        fun addEntry(entry: Tenant) = apply {
            entries =
         ...
         */
        fun build(): TenantListPageResponse =
            TenantListPageResponse(
    ...
    fun validate(): TenantListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TenantListPageResponse && entries == other.entries && pageInfo == other.pageInfo && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "TenantListPageResponse{entries=$entries, pageInfo=$pageInfo, additionalProperties=$additionalProperties}"
}
