...
class ObjectGetChannelDataResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ObjectGetChannelDataResponse].
         *
    ...
    /** A builder for [ObjectGetChannelDataResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(objectGetChannelDataResponse: ObjectGetChannelDataResponse) = apply {
            channelId = objectGetChannelDataResponse.channelId
            data = objectGetChannelDataResponse.data
            provider = objectGetChannelDataResponse.provider
            additionalProperties = objectGetChannelDataResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ObjectGetChannelDataResponse].
         *
         ...
         */
        fun build(): ObjectGetChannelDataResponse =
    ...
    fun validate(): ObjectGetChannelDataResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ObjectGetChannelDataResponse && channelId == other.channelId && data == other.data && provider == other.provider && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ObjectGetChannelDataResponse{channelId=$channelId, data=$data, provider=$provider, additionalProperties=$additionalProperties}"
}
