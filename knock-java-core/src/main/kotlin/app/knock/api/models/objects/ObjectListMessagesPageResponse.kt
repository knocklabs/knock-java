...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(objectListMessagesPageResponse: ObjectListMessagesPageResponse) = apply {
            items = objectListMessagesPageResponse.items.map { it.toMutableList() }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ObjectListMessagesPageResponse && items == other.items && pageInfo == other.pageInfo && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ObjectListMessagesPageResponse{items=$items, pageInfo=$pageInfo, additionalProperties=$additionalProperties}"
}
