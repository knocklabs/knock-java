...
private constructor(
    ...
    companion object {
         ...
         * [ObjectListMessagesPageResponse].
         *
    ...
    /** A builder for [ObjectListMessagesPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(objectListMessagesPageResponse: ObjectListMessagesPageResponse) = apply {
            entries = objectListMessagesPageResponse.entries.map { it.toMutableList() }
            pageInfo = objectListMessagesPageResponse.pageInfo
            additionalProperties =
                objectListMessagesPageResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): ObjectListMessagesPageResponse =
            ObjectListMessagesPageResponse(
    ...
    fun validate(): ObjectListMessagesPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ObjectListMessagesPageResponse && entries == other.entries && pageInfo == other.pageInfo && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ObjectListMessagesPageResponse{entries=$entries, pageInfo=$pageInfo, additionalProperties=$additionalProperties}"
}
