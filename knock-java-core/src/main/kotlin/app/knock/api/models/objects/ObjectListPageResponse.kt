...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        entries: JsonField<List<Object>> = JsonMissing.of(),
     ...
     */
    fun entries(): List<Object> = entries.getRequired("entries")
     ...
     */
    @JsonProperty("entries") @ExcludeMissing fun _entries(): JsonField<List<Object>> = entries
    ...
    /** A builder for [ObjectListPageResponse]. */
    class Builder internal constructor() {

        private var entries: JsonField<MutableList<Object>>? = null
        private var pageInfo: JsonField<PageInfo>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(objectListPageResponse: ObjectListPageResponse) = apply {
            entries = objectListPageResponse.entries.map { it.toMutableList() }
            pageInfo = objectListPageResponse.pageInfo
            additionalProperties = objectListPageResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.entries] with a well-typed `List<Object>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun entries(entries: JsonField<List<Object>>) = apply {
         ...
         */
        fun addEntry(entry: Object) = apply {
            entries =
         ...
         */
        fun build(): ObjectListPageResponse =
            ObjectListPageResponse(
    ...
    fun validate(): ObjectListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ObjectListPageResponse && entries == other.entries && pageInfo == other.pageInfo && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ObjectListPageResponse{entries=$entries, pageInfo=$pageInfo, additionalProperties=$additionalProperties}"
}
