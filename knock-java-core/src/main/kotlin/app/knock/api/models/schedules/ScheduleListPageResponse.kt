...
class ScheduleListPageResponse
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scheduleListPageResponse: ScheduleListPageResponse) = apply {
            entries = scheduleListPageResponse.entries.map { it.toMutableList() }
            pageInfo = scheduleListPageResponse.pageInfo
            additionalProperties = scheduleListPageResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): ScheduleListPageResponse =
            ScheduleListPageResponse(
    ...
    fun validate(): ScheduleListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ScheduleListPageResponse && entries == other.entries && pageInfo == other.pageInfo && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ScheduleListPageResponse{entries=$entries, pageInfo=$pageInfo, additionalProperties=$additionalProperties}"
}
