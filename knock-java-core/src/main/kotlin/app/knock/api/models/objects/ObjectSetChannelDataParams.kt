...
/** Set channel data */
class ObjectSetChannelDataParams private constructor(
    ...
    fun _additionalBodyProperties(): Map<String, JsonValue> = channelDataRequest._additionalProperties()
    ...
    @JvmSynthetic
    internal fun _body(): ChannelDataRequest = channelDataRequest
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(objectSetChannelDataParams: ObjectSetChannelDataParams) =
            apply {
        ...
        fun build(): ObjectSetChannelDataParams =
            ObjectSetChannelDataParams(
              ...
              checkRequired(
                "channelDataRequest", channelDataRequest
              ),
    ...
    override fun toString() = "ObjectSetChannelDataParams{collection=$collection, objectId=$objectId, channelId=$channelId, channelDataRequest=$channelDataRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
