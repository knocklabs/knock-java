...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(inlinePreferenceSetRequest: InlinePreferenceSetRequest) = apply {
            id = inlinePreferenceSetRequest.id
            categories = inlinePreferenceSetRequest.categories
            channelTypes = inlinePreferenceSetRequest.channelTypes
            workflows = inlinePreferenceSetRequest.workflows
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is InlinePreferenceSetRequest && id == other.id && categories == other.categories && channelTypes == other.channelTypes && workflows == other.workflows && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "InlinePreferenceSetRequest{id=$id, categories=$categories, channelTypes=$channelTypes, workflows=$workflows, additionalProperties=$additionalProperties}"
}
