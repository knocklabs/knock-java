...
/** List schedules */
class ObjectListSchedulesPage private constructor(
    ...
    override fun toString() = "ObjectListSchedulesPage{objectsService=$objectsService, params=$params, response=$response}"
    ...
    companion object {
        ...
        @JvmStatic
        fun of(objectsService: ObjectService, params: ObjectListSchedulesParams, response: Response) =
    ...
    class AutoPager(
        private val firstPage: ObjectListSchedulesPage,
