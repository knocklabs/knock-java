...
@NoAutoDetect
class MsTeamListTeamsResponse @JsonCreator private constructor(
    @JsonProperty("ms_teams_teams") @ExcludeMissing private val msTeamsTeams: JsonField<List<MsTeamsTeam>> = JsonMissing.of(),
    @JsonProperty("skip_token") @ExcludeMissing private val skipToken: JsonField<String> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _skipToken(): JsonField<String> = skipToken
    ...
    fun validate(): MsTeamListTeamsResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(msTeamListTeamsResponse: MsTeamListTeamsResponse) =
            apply {
        ...
        fun msTeamsTeams(msTeamsTeams: JsonField<List<MsTeamsTeam>>) =
            apply {
                this.msTeamsTeams = msTeamsTeams.map { it.toMutableList() }
            }

        fun addMsTeamsTeam(msTeamsTeam: MsTeamsTeam) =
            apply {
                msTeamsTeams = (msTeamsTeams ?: JsonField.of(mutableListOf())).also {
        ...
        fun skipToken(skipToken: JsonField<String>) =
            apply {
    ...
    @NoAutoDetect
    class MsTeamsTeam @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(msTeamsTeam: MsTeamsTeam) =
                apply {
                    id = msTeamsTeam.id
        ...
        override fun toString() = "MsTeamsTeam{id=$id, displayName=$displayName, description=$description, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "MsTeamListTeamsResponse{msTeamsTeams=$msTeamsTeams, skipToken=$skipToken, additionalProperties=$additionalProperties}"
}
