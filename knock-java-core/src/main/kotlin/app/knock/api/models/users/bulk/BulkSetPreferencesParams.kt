...
class BulkSetPreferencesParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("preferences") @ExcludeMissing private val preferences: JsonField<PreferenceSetRequest> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            /** Set preferences for a recipient */
            fun preferences(preferences: PreferenceSetRequest) = preferences(JsonField.of(preferences))

            /** Set preferences for a recipient */
            fun preferences(preferences: JsonField<PreferenceSetRequest>) =
                apply {
        ...
        override fun toString() = "Body{preferences=$preferences, userIds=$userIds, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bulkSetPreferencesParams: BulkSetPreferencesParams) =
            apply {
    ...
    override fun toString() = "BulkSetPreferencesParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
