...
class UserGetChannelDataResponse
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserGetChannelDataResponse].
         *
    ...
    /** A builder for [UserGetChannelDataResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userGetChannelDataResponse: UserGetChannelDataResponse) = apply {
            channelId = userGetChannelDataResponse.channelId
            data = userGetChannelDataResponse.data
            provider = userGetChannelDataResponse.provider
            additionalProperties = userGetChannelDataResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserGetChannelDataResponse].
         *
         ...
         */
        fun build(): UserGetChannelDataResponse =
    ...
    fun validate(): UserGetChannelDataResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is UserGetChannelDataResponse && channelId == other.channelId && data == other.data && provider == other.provider && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "UserGetChannelDataResponse{channelId=$channelId, data=$data, provider=$provider, additionalProperties=$additionalProperties}"
}
