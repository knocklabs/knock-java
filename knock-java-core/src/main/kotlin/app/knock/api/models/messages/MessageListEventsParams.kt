...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageListEventsParams: MessageListEventsParams) = apply {
    ...
    override fun toString() =
        "MessageListEventsParams{messageId=$messageId, after=$after, before=$before, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
