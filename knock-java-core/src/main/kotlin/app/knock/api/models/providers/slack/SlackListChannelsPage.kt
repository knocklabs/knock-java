...
class SlackListChannelsPage private constructor(
    ...
    override fun toString() = "SlackListChannelsPage{slackService=$slackService, params=$params, response=$response}"
    ...
    class AutoPager(
        private val firstPage: SlackListChannelsPage,

    ) : Iterable<SlackListChannelsResponse> {

        override fun iterator(): Iterator<SlackListChannelsResponse> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
