        ...
        private constructor(
            ...
            fun <T> accept(visitor: Visitor<T>): T =
                when {
                    ...
                    inlineObjectRequest != null ->
                        visitor.visitInlineObjectRequest(inlineObjectRequest)
            ...
            companion object {
                 ...
                 * It will perform an upsert for the user you're supplying, replacing any properties
                 * specified.
                 */
                @JvmStatic
                fun ofInlineIdentifyUserRequest(
                    inlineIdentifyUserRequest: InlineIdentifyUserRequest
                ) = Recipient(inlineIdentifyUserRequest = inlineIdentifyUserRequest)
            ...
            /**
             * An interface that defines how to map each variant of [Recipient] to a value of type
             * [T].
             */
            ...
            internal class Deserializer : BaseDeserializer<Recipient>(Recipient::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Recipient {
                    ...
                    val bestMatches =
                        sequenceOf(
                                tryDeserialize(node, jacksonTypeRef<InlineIdentifyUserRequest>())
                                    ?.let {
