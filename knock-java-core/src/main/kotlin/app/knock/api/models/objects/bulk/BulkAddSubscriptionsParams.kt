 ...
 */
class BulkAddSubscriptionsParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("subscriptions") @ExcludeMissing private val subscriptions: JsonField<List<Subscription>> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            fun subscriptions(subscriptions: List<Subscription>) = subscriptions(JsonField.of(subscriptions))

            fun subscriptions(subscriptions: JsonField<List<Subscription>>) =
                apply {
            ...
            fun addSubscription(subscription: Subscription) =
                apply {
                    subscriptions = (subscriptions ?: JsonField.of(mutableListOf())).also {
        ...
        override fun toString() = "Body{subscriptions=$subscriptions, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bulkAddSubscriptionsParams: BulkAddSubscriptionsParams) =
            apply {
    ...
    class Subscription @JsonCreator private constructor(
        ...
        @JsonProperty("properties") @ExcludeMissing private val properties: JsonField<Properties> = JsonMissing.of(),
        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
        ...
        fun properties(): Optional<Properties> = Optional.ofNullable(properties.getNullable("properties"))
        ...
        override fun toString() = "Subscription{id=$id, recipients=$recipients, properties=$properties, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "BulkAddSubscriptionsParams{collection=$collection, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
