...
/** List schedules */
class ScheduleListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scheduleListParams: ScheduleListParams) =
            apply {
    ...
    override fun toString() = "ScheduleListParams{workflow=$workflow, after=$after, before=$before, pageSize=$pageSize, recipients=$recipients, tenant=$tenant, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
