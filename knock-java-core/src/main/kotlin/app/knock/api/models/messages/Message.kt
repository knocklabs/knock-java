...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [addActor] with `Actor.ofUserReference(userReference)`. */
        fun addActor(userReference: String) = addActor(Actor.ofUserReference(userReference))
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Actor && userReference == other.userReference && objectReference == other.objectReference /* spotless:on */
        }
        ...
        override fun toString(): String =
            when {
                userReference != null -> "Actor{userReference=$userReference}"
                ...
                val bestMatches =
                    sequenceOf(
                            tryDeserialize(node, jacksonTypeRef<ObjectReference>())?.let {
                                Actor(objectReference = it, _json = json)
                            },
                            tryDeserialize(node, jacksonTypeRef<String>())?.let {
                                Actor(userReference = it, _json = json)
                            },
                        )
                        .filterNotNull()
