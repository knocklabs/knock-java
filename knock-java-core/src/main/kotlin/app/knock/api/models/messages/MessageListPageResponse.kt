...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(messageListPageResponse: MessageListPageResponse) = apply {
            items = messageListPageResponse.items.map { it.toMutableList() }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageListPageResponse && items == other.items && pageInfo == other.pageInfo && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageListPageResponse{items=$items, pageInfo=$pageInfo, additionalProperties=$additionalProperties}"
}
