...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(messageListPageResponse: MessageListPageResponse) = apply {
            entries = messageListPageResponse.entries.map { it.toMutableList() }
            pageInfo = messageListPageResponse.pageInfo
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageListPageResponse && entries == other.entries && pageInfo == other.pageInfo && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageListPageResponse{entries=$entries, pageInfo=$pageInfo, additionalProperties=$additionalProperties}"
}
