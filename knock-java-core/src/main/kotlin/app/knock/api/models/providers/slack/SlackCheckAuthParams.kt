...
class SlackCheckAuthParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(slackCheckAuthParams: SlackCheckAuthParams) =
            apply {
    ...
    override fun toString() = "SlackCheckAuthParams{channelId=$channelId, accessTokenObject=$accessTokenObject, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
