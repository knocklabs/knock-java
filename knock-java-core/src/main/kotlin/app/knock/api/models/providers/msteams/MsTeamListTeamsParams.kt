 ...
 */
class MsTeamListTeamsParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(msTeamListTeamsParams: MsTeamListTeamsParams) =
            apply {
    ...
    class QueryOptions private constructor(
        ...
        internal fun forEachQueryParam(putParam: (String, List<String>) -> Unit) {
          this.filter?.let {
              putParam(
                "\$filter", listOf(it.toString())
              )
          }
          this.select?.let {
              putParam(
                "\$select", listOf(it.toString())
              )
          }
          this.skiptoken?.let {
              putParam(
                "\$skiptoken", listOf(it.toString())
              )
          }
          this.top?.let {
              putParam(
                "\$top", listOf(it.toString())
              )
          }
        ...
        class Builder internal constructor() {
             ...
             * to the Microsoft Graph API to retrieve the next page of results
             */
            fun skiptoken(skiptoken: String?) =
                apply {
        ...
        override fun toString() = "QueryOptions{filter=$filter, select=$select, skiptoken=$skiptoken, top=$top, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "MsTeamListTeamsParams{channelId=$channelId, msTeamsTenantObject=$msTeamsTenantObject, queryOptions=$queryOptions, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
