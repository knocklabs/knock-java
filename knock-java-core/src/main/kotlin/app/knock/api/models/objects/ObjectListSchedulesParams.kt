...
/** List schedules */
class ObjectListSchedulesParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(objectListSchedulesParams: ObjectListSchedulesParams) =
            apply {
    ...
    override fun toString() = "ObjectListSchedulesParams{collection=$collection, objectId=$objectId, after=$after, before=$before, pageSize=$pageSize, tenant=$tenant, workflow=$workflow, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
