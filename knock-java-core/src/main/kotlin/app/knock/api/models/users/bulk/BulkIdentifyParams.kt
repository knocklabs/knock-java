...
class BulkIdentifyParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("users") @ExcludeMissing private val users: JsonField<List<InlineIdentifyUserRequest>> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            fun users(users: JsonField<List<InlineIdentifyUserRequest>>) =
                apply {
                    this.users = users.map { it.toMutableList() }
                }

            fun addUser(user: InlineIdentifyUserRequest) =
                apply {
                    users = (users ?: JsonField.of(mutableListOf())).also {
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bulkIdentifyParams: BulkIdentifyParams) =
            apply {
        ...
        fun users(users: List<InlineIdentifyUserRequest>) =
            apply {
                body.users(users)
            }
    ...
    override fun toString() = "BulkIdentifyParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
