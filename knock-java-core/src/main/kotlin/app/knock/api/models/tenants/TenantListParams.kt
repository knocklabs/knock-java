...
/** List tenants */
class TenantListParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): TenantListParams = builder().build()
    ...
    override fun toString() = "TenantListParams{after=$after, before=$before, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
