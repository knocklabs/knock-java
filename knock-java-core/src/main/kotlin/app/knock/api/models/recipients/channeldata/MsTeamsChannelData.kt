...
@NoAutoDetect
class MsTeamsChannelData @JsonCreator private constructor(
    @JsonProperty("connections") @ExcludeMissing private val connections: JsonField<List<Connection>> = JsonMissing.of(),
    @JsonProperty("ms_teams_tenant_id") @ExcludeMissing private val msTeamsTenantId: JsonField<String> = JsonMissing.of(),
    ...
    fun msTeamsTenantId(): Optional<String> = Optional.ofNullable(msTeamsTenantId.getNullable("ms_teams_tenant_id"))
    ...
    fun validate(): MsTeamsChannelData =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(msTeamsChannelData: MsTeamsChannelData) =
            apply {
        ...
        fun addConnection(msTeamsToken: Connection.MsTeamsTokenConnection) = addConnection(Connection.ofMsTeamsToken(msTeamsToken))

        /** Microsoft Teams incoming webhook connection */
        fun addConnection(msTeamsIncomingWebhook: Connection.MsTeamsIncomingWebhookConnection) = addConnection(Connection.ofMsTeamsIncomingWebhook(msTeamsIncomingWebhook))

        /** The Microsoft Teams tenant ID */
        fun msTeamsTenantId(msTeamsTenantId: String?) = msTeamsTenantId(JsonField.ofNullable(msTeamsTenantId))

        /** The Microsoft Teams tenant ID */
        fun msTeamsTenantId(msTeamsTenantId: Optional<String>) = msTeamsTenantId(msTeamsTenantId.getOrNull())

        /** The Microsoft Teams tenant ID */
        fun msTeamsTenantId(msTeamsTenantId: JsonField<String>) =
            apply {
    ...
    class Connection private constructor(
        ...
        /** Microsoft Teams incoming webhook connection */
        fun msTeamsIncomingWebhook(): Optional<MsTeamsIncomingWebhookConnection> = Optional.ofNullable(msTeamsIncomingWebhook)
        ...
        /** Microsoft Teams incoming webhook connection */
        fun asMsTeamsIncomingWebhook(): MsTeamsIncomingWebhookConnection = msTeamsIncomingWebhook.getOrThrow("msTeamsIncomingWebhook")
        ...
        fun <T> accept(visitor: Visitor<T>): T {
          return when {
              ...
              msTeamsIncomingWebhook != null -> visitor.visitMsTeamsIncomingWebhook(msTeamsIncomingWebhook)
        ...
        fun validate(): Connection =
            apply {
                ...
                accept(object : Visitor<Unit> {
                    ...
                    override fun visitMsTeamsIncomingWebhook(msTeamsIncomingWebhook: MsTeamsIncomingWebhookConnection) {
        ...
        override fun toString(): String =
            when {
                ...
                msTeamsIncomingWebhook != null -> "Connection{msTeamsIncomingWebhook=$msTeamsIncomingWebhook}"
        ...
        companion object {
            ...
            /** Microsoft Teams token connection */
            @JvmStatic
            fun ofMsTeamsToken(msTeamsToken: MsTeamsTokenConnection) = Connection(msTeamsToken = msTeamsToken)

            /** Microsoft Teams incoming webhook connection */
            @JvmStatic
            fun ofMsTeamsIncomingWebhook(msTeamsIncomingWebhook: MsTeamsIncomingWebhookConnection) = Connection(msTeamsIncomingWebhook = msTeamsIncomingWebhook)
        }
        ...
        interface Visitor<out T> {
            ...
            /** Microsoft Teams incoming webhook connection */
            fun visitMsTeamsIncomingWebhook(msTeamsIncomingWebhook: MsTeamsIncomingWebhookConnection): T
        ...
        internal class Deserializer : BaseDeserializer<Connection>(Connection::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Connection {
              ...
              tryDeserialize(node, jacksonTypeRef<MsTeamsTokenConnection>()){ it.validate() }?.let {
                  return Connection(msTeamsToken = it, _json = json)
              }
              tryDeserialize(node, jacksonTypeRef<MsTeamsIncomingWebhookConnection>()){ it.validate() }?.let {
        ...
        internal class Serializer : BaseSerializer<Connection>(Connection::class) {
            ...
            override fun serialize(value: Connection, generator: JsonGenerator, provider: SerializerProvider) {
              when {
                  ...
                  value.msTeamsIncomingWebhook != null -> generator.writeObject(value.msTeamsIncomingWebhook)
        ...
        /** Microsoft Teams token connection */
        @NoAutoDetect
        class MsTeamsTokenConnection @JsonCreator private constructor(
            @JsonProperty("ms_teams_channel_id") @ExcludeMissing private val msTeamsChannelId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("ms_teams_team_id") @ExcludeMissing private val msTeamsTeamId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("ms_teams_tenant_id") @ExcludeMissing private val msTeamsTenantId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("ms_teams_user_id") @ExcludeMissing private val msTeamsUserId: JsonField<String> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),

        ) {

            /** The Microsoft Teams channel ID */
            fun msTeamsChannelId(): Optional<String> = Optional.ofNullable(msTeamsChannelId.getNullable("ms_teams_channel_id"))

            /** The Microsoft Teams team ID */
            fun msTeamsTeamId(): Optional<String> = Optional.ofNullable(msTeamsTeamId.getNullable("ms_teams_team_id"))

            /** The Microsoft Teams tenant ID */
            fun msTeamsTenantId(): Optional<String> = Optional.ofNullable(msTeamsTenantId.getNullable("ms_teams_tenant_id"))

            /** The Microsoft Teams user ID */
            fun msTeamsUserId(): Optional<String> = Optional.ofNullable(msTeamsUserId.getNullable("ms_teams_user_id"))
            ...
            fun validate(): MsTeamsTokenConnection =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(msTeamsTokenConnection: MsTeamsTokenConnection) =
                    apply {
                        ...
                        additionalProperties = msTeamsTokenConnection.additionalProperties.toMutableMap()
                    }

                /** The Microsoft Teams channel ID */
                fun msTeamsChannelId(msTeamsChannelId: String?) = msTeamsChannelId(JsonField.ofNullable(msTeamsChannelId))

                /** The Microsoft Teams channel ID */
                fun msTeamsChannelId(msTeamsChannelId: Optional<String>) = msTeamsChannelId(msTeamsChannelId.getOrNull())

                /** The Microsoft Teams channel ID */
                fun msTeamsChannelId(msTeamsChannelId: JsonField<String>) =
                    apply {
                        this.msTeamsChannelId = msTeamsChannelId
                    }

                /** The Microsoft Teams team ID */
                fun msTeamsTeamId(msTeamsTeamId: String?) = msTeamsTeamId(JsonField.ofNullable(msTeamsTeamId))

                /** The Microsoft Teams team ID */
                fun msTeamsTeamId(msTeamsTeamId: Optional<String>) = msTeamsTeamId(msTeamsTeamId.getOrNull())

                /** The Microsoft Teams team ID */
                fun msTeamsTeamId(msTeamsTeamId: JsonField<String>) =
                    apply {
                ...
                /** The Microsoft Teams user ID */
                fun msTeamsUserId(msTeamsUserId: String?) = msTeamsUserId(JsonField.ofNullable(msTeamsUserId))

                /** The Microsoft Teams user ID */
                fun msTeamsUserId(msTeamsUserId: Optional<String>) = msTeamsUserId(msTeamsUserId.getOrNull())

                /** The Microsoft Teams user ID */
                fun msTeamsUserId(msTeamsUserId: JsonField<String>) =
                    apply {
            ...
            override fun toString() = "MsTeamsTokenConnection{msTeamsChannelId=$msTeamsChannelId, msTeamsTeamId=$msTeamsTeamId, msTeamsTenantId=$msTeamsTenantId, msTeamsUserId=$msTeamsUserId, additionalProperties=$additionalProperties}"
        }

        /** Microsoft Teams incoming webhook connection */
        @NoAutoDetect
        class MsTeamsIncomingWebhookConnection @JsonCreator private constructor(
            ...
            fun validate(): MsTeamsIncomingWebhookConnection =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(msTeamsIncomingWebhookConnection: MsTeamsIncomingWebhookConnection) =
                    apply {
                        incomingWebhook = msTeamsIncomingWebhookConnection.incomingWebhook
                        additionalProperties = msTeamsIncomingWebhookConnection.additionalProperties.toMutableMap()
                    }
            ...
            override fun toString() = "MsTeamsIncomingWebhookConnection{incomingWebhook=$incomingWebhook, additionalProperties=$additionalProperties}"
        }
    }
    ...
    override fun toString() = "MsTeamsChannelData{connections=$connections, msTeamsTenantId=$msTeamsTenantId, additionalProperties=$additionalProperties}"
}
