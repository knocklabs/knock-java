...
class BulkDeleteParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.objectIds.let {
          queryParams.put(
            "object_ids[]", it.map(Any::toString)
          )
      }
    ...
    class Builder internal constructor() {
        ...
        /** The IDs of the objects to delete */
        fun objectIds(objectIds: List<String>) =
            apply {
                this.objectIds = objectIds.toMutableList()
            }

        /** The IDs of the objects to delete */
        fun addObjectId(objectId: String) =
            apply {
    ...
    override fun toString() = "BulkDeleteParams{collection=$collection, objectIds=$objectIds, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
