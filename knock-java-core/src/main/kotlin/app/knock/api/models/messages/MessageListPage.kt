...
/** List messages */
class MessageListPage private constructor(
    ...
    override fun toString() = "MessageListPage{messagesService=$messagesService, params=$params, response=$response}"
    ...
    class AutoPager(
        private val firstPage: MessageListPage,
