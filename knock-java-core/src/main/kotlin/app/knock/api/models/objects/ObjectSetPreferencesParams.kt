...
class ObjectSetPreferencesParams private constructor(
    ...
    fun _additionalBodyProperties(): Map<String, JsonValue> = preferenceSetRequest._additionalProperties()
    ...
    @JvmSynthetic
    internal fun _body(): PreferenceSetRequest = preferenceSetRequest
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(objectSetPreferencesParams: ObjectSetPreferencesParams) =
            apply {
    ...
    override fun toString() = "ObjectSetPreferencesParams{collection=$collection, objectId=$objectId, preferenceSetId=$preferenceSetId, preferenceSetRequest=$preferenceSetRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
