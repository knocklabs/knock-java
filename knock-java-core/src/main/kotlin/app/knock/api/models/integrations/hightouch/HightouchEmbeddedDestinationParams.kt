...
private constructor(
    ...
    /** A builder for [HightouchEmbeddedDestinationParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hightouchEmbeddedDestinationParams: HightouchEmbeddedDestinationParams) =
            apply {
                body = hightouchEmbeddedDestinationParams.body.toBuilder()
                additionalHeaders = hightouchEmbeddedDestinationParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    hightouchEmbeddedDestinationParams.additionalQueryParams.toBuilder()
            }
         ...
         */
        fun build(): HightouchEmbeddedDestinationParams =
            HightouchEmbeddedDestinationParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is HightouchEmbeddedDestinationParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "HightouchEmbeddedDestinationParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
