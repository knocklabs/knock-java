...
interface BulkServiceAsync {
     ...
     * `unarchive`).
     */
    fun updateMessageStatus(params: BulkUpdateMessageStatusParams): CompletableFuture<BulkOperation> =
        updateMessageStatus(
          params, RequestOptions.none()
        )

    /** @see [updateMessageStatus] */
    fun updateMessageStatus(params: BulkUpdateMessageStatusParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<BulkOperation>
    ...
    interface WithRawResponse {
         ...
         * same as [BulkServiceAsync.updateMessageStatus].
         */
        @MustBeClosed
        fun updateMessageStatus(params: BulkUpdateMessageStatusParams): CompletableFuture<HttpResponseFor<BulkOperation>> =
            updateMessageStatus(
              params, RequestOptions.none()
            )
        ...
        /** @see [updateMessageStatus] */
        @MustBeClosed
        fun updateMessageStatus(params: BulkUpdateMessageStatusParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<BulkOperation>>
    }
}
