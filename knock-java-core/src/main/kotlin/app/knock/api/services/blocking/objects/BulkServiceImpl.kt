...
class BulkServiceImpl internal constructor(
    ...
    override fun addSubscriptions(params: BulkAddSubscriptionsParams, requestOptions: RequestOptions): BulkOperation =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun addSubscriptions(params: BulkAddSubscriptionsParams, requestOptions: RequestOptions): HttpResponseFor<BulkOperation> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun set(params: BulkSetParams, requestOptions: RequestOptions): HttpResponseFor<BulkOperation> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
