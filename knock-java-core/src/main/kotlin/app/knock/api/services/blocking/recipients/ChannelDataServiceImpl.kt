...
class ChannelDataServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ChannelDataService {

    private val withRawResponse: ChannelDataService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
